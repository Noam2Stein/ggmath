...
pub fn vec2(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("vector::Vec2").unwrap(), input)
}
pub fn vec3(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("vector::Vec3").unwrap(), input)
}
pub fn vec4(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("vector::Vec4").unwrap(), input)
}

pub fn vec2p(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("vector::Vec2P").unwrap(), input)
}
pub fn vec3p(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("vector::Vec3P").unwrap(), input)
}
pub fn vec4p(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("vector::Vec4P").unwrap(), input)
}

pub fn mat2(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat2").unwrap(), input)
}
pub fn mat2x3(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat2x3").unwrap(), input)
}
pub fn mat2x4(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat2x4").unwrap(), input)
}
pub fn mat3x2(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat3x2").unwrap(), input)
}
pub fn mat3(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat3").unwrap(), input)
}
pub fn mat3x4(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat3x4").unwrap(), input)
}
pub fn mat4x2(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat4x2").unwrap(), input)
}
pub fn mat4x3(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat4x3").unwrap(), input)
}
pub fn mat4(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat4").unwrap(), input)
}

pub fn mat2a(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat2A").unwrap(), input)
}
pub fn mat2x3a(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat2x3A").unwrap(), input)
}
pub fn mat2x4a(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat2x4A").unwrap(), input)
}
pub fn mat3x2a(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat3x2A").unwrap(), input)
}
pub fn mat3a(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat3A").unwrap(), input)
}
pub fn mat3x4a(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat3x4A").unwrap(), input)
}
pub fn mat4x2a(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat4x2A").unwrap(), input)
}
pub fn mat4x3a(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat4x3A").unwrap(), input)
}
pub fn mat4a(input: TokenStream1) -> TokenStream1 {
    builder(parse_str("matrix::Mat4A").unwrap(), input)
}

fn builder(ty: Path, input: TokenStream1) -> TokenStream1 {
    let Input { segments: exprs } = parse_macro_input!(input);
    let exprs = exprs.into_iter().map(|segment| segment.exprs);

    quote! {
        {
            use ggmath::builder::FromBuilder;
            ggmath::#ty::from_builder((#(
