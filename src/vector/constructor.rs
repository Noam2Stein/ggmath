...
pub use crate::{vec2, vec2g, vec2s, vec3, vec3g, vec3s, vec4, vec4g, vec4s};
...
impl<T: Scalar<2>, S: Simdness> From<(T, T)> for Vector<2, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<2>, S: Simdness> From<(T, Vector<1, T, S>)> for Vector<2, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<2>, S: Simdness> From<(Vector<1, T, S>, T)> for Vector<2, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<2>, S: Simdness> From<(Vector<1, T, S>, Vector<1, T, S>)>
    for Vector<2, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<3>, S: Simdness> From<(T, T, T)> for Vector<3, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<3>, S: Simdness> From<(T, T, Vector<1, T, S>)> for Vector<3, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<3>, S: Simdness> From<(T, Vector<1, T, S>, T)> for Vector<3, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<3>, S: Simdness> From<(T, Vector<1, T, S>, Vector<1, T, S>)>
    for Vector<3, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<2> + Scalar<3>, S: Simdness> From<(T, Vector<2, T, S>)> for Vector<3, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<3>, S: Simdness> From<(Vector<1, T, S>, T, T)> for Vector<3, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<3>, S: Simdness> From<(Vector<1, T, S>, T, Vector<1, T, S>)>
    for Vector<3, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<3>, S: Simdness> From<(Vector<1, T, S>, Vector<1, T, S>, T)>
    for Vector<3, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<3>, S: Simdness>
...
impl<T: Scalar<1> + Scalar<2> + Scalar<3>, S: Simdness> From<(Vector<1, T, S>, Vector<2, T, S>)>
    for Vector<3, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<2> + Scalar<3>, S: Simdness> From<(Vector<2, T, S>, T)> for Vector<3, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<2> + Scalar<3>, S: Simdness> From<(Vector<2, T, S>, Vector<1, T, S>)>
    for Vector<3, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<4>, S: Simdness> From<(T, T, T, T)> for Vector<4, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<4>, S: Simdness> From<(T, T, T, Vector<1, T, S>)> for Vector<4, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<4>, S: Simdness> From<(T, T, Vector<1, T, S>, T)> for Vector<4, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<4>, S: Simdness> From<(T, T, Vector<1, T, S>, Vector<1, T, S>)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<2> + Scalar<4>, S: Simdness> From<(T, T, Vector<2, T, S>)> for Vector<4, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<4>, S: Simdness> From<(T, Vector<1, T, S>, T, T)> for Vector<4, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<4>, S: Simdness> From<(T, Vector<1, T, S>, T, Vector<1, T, S>)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<4>, S: Simdness> From<(T, Vector<1, T, S>, Vector<1, T, S>, T)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<4>, S: Simdness>
...
impl<T: Scalar<1> + Scalar<2> + Scalar<4>, S: Simdness> From<(T, Vector<1, T, S>, Vector<2, T, S>)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<2> + Scalar<4>, S: Simdness> From<(T, Vector<2, T, S>, T)> for Vector<4, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<2> + Scalar<4>, S: Simdness> From<(T, Vector<2, T, S>, Vector<1, T, S>)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<3> + Scalar<4>, S: Simdness> From<(T, Vector<3, T, S>)> for Vector<4, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<4>, S: Simdness> From<(Vector<1, T, S>, T, T, T)> for Vector<4, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<4>, S: Simdness> From<(Vector<1, T, S>, T, T, Vector<1, T, S>)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<4>, S: Simdness> From<(Vector<1, T, S>, T, Vector<1, T, S>, T)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<2> + Scalar<4>, S: Simdness> From<(Vector<1, T, S>, T, Vector<2, T, S>)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<4>, S: Simdness> From<(Vector<1, T, S>, Vector<1, T, S>, T, T)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<2> + Scalar<4>, S: Simdness>
...
impl<T: Scalar<1> + Scalar<2> + Scalar<4>, S: Simdness> From<(Vector<1, T, S>, Vector<2, T, S>, T)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<3> + Scalar<4>, S: Simdness> From<(Vector<1, T, S>, Vector<3, T, S>)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<2> + Scalar<4>, S: Simdness> From<(Vector<2, T, S>, T, T)> for Vector<4, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<2> + Scalar<4>, S: Simdness> From<(Vector<2, T, S>, T, Vector<1, T, S>)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<2> + Scalar<4>, S: Simdness> From<(Vector<2, T, S>, Vector<1, T, S>, T)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<2> + Scalar<4>, S: Simdness> From<(Vector<2, T, S>, Vector<2, T, S>)>
    for Vector<4, T, S>
{
    #[inline(always)]
...
impl<T: Scalar<3> + Scalar<4>, S: Simdness> From<(Vector<3, T, S>, T)> for Vector<4, T, S> {
    #[inline(always)]
...
impl<T: Scalar<1> + Scalar<3> + Scalar<4>, S: Simdness> From<(Vector<3, T, S>, Vector<1, T, S>)>
    for Vector<4, T, S>
{
    #[inline(always)]
