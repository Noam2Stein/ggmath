...
impl ScalarZero for f32 {
    ...
    const VEC2_ZERO: Vec2<f32> = Vec2::const_from_array([0.0; 2]);
    const VEC3_ZERO: Vec3<f32> = Vec3::const_from_array([0.0; 3]);
    const VEC4_ZERO: Vec4<f32> = Vec4::const_from_array([0.0; 4]);
}

impl ScalarOne for f32 {
    const ONE: Self = 1.0;

    const VEC2_ONE: Vec2<f32> = Vec2::const_from_array([1.0; 2]);
    const VEC3_ONE: Vec3<f32> = Vec3::const_from_array([1.0; 3]);
    const VEC4_ONE: Vec4<f32> = Vec4::const_from_array([1.0; 4]);

    const VEC2_x: Vec2<f32> = Vec2::const_from_array([1.0, 0.0]);

    const VEC2_y: Vec2<f32> = Vec2::const_from_array([0.0, 1.0]);

    const VEC3_x: Vec3<f32> = Vec3::const_from_array([1.0, 0.0, 0.0]);

    const VEC3_y: Vec3<f32> = Vec3::const_from_array([0.0, 1.0, 0.0]);

    const VEC3_z: Vec3<f32> = Vec3::const_from_array([0.0, 0.0, 1.0]);

    const VEC4_x: Vec4<f32> = Vec4::const_from_array([1.0, 0.0, 0.0, 0.0]);

    const VEC4_y: Vec4<f32> = Vec4::const_from_array([0.0, 1.0, 0.0, 0.0]);

    const VEC4_z: Vec4<f32> = Vec4::const_from_array([0.0, 0.0, 1.0, 0.0]);

    const VEC4_w: Vec4<f32> = Vec4::const_from_array([0.0, 0.0, 0.0, 1.0]);
}

impl ScalarNegOne for f32 {
    const NEG_ONE: Self = -1.0;

    const VEC2_NEG_ONE: Vec2<f32> = Vec2::const_from_array([-1.0; 2]);
    const VEC3_NEG_ONE: Vec3<f32> = Vec3::const_from_array([-1.0; 3]);
    const VEC4_NEG_ONE: Vec4<f32> = Vec4::const_from_array([-1.0; 4]);

    const VEC2_NEG_x: Vec2<f32> = Vec2::const_from_array([-1.0, 0.0]);

    const VEC2_NEG_y: Vec2<f32> = Vec2::const_from_array([0.0, -1.0]);

    const VEC3_NEG_x: Vec3<f32> = Vec3::const_from_array([-1.0, 0.0, 0.0]);

    const VEC3_NEG_y: Vec3<f32> = Vec3::const_from_array([0.0, -1.0, 0.0]);

    const VEC3_NEG_z: Vec3<f32> = Vec3::const_from_array([0.0, 0.0, -1.0]);

    const VEC4_NEG_x: Vec4<f32> = Vec4::const_from_array([-1.0, 0.0, 0.0, 0.0]);

    const VEC4_NEG_y: Vec4<f32> = Vec4::const_from_array([0.0, -1.0, 0.0, 0.0]);

    const VEC4_NEG_z: Vec4<f32> = Vec4::const_from_array([0.0, 0.0, -1.0, 0.0]);

    const VEC4_NEG_w: Vec4<f32> = Vec4::const_from_array([0.0, 0.0, 0.0, -1.0]);
}
