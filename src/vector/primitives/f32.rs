    ...
    Usize<N>: VecLen,
{
    ...
    pub const MIN: Self = Self::const_from_array([f32::MIN; N]);
    /// A vector of all maximum values.
    pub const MAX: Self = Self::const_from_array([f32::MAX; N]);
    /// A vector with all elements set to `NaN`.
    pub const NAN: Self = Self::const_from_array([f32::NAN; N]);
    /// A vector with all elements set to `Infinity`.
    pub const INFINITY: Self = Self::const_from_array([f32::INFINITY; N]);
    /// A vector with all elements set to `-Infinity`.
    pub const NEG_INFINITY: Self = Self::const_from_array([f32::NEG_INFINITY; N]);
    /// A vector with all elements set to `Epsilon`.
    pub const EPSILON: Self = Self::const_from_array([f32::EPSILON; N]);
