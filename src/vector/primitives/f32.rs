    ...
    Usize<N>: VecLen,
{
    ...
    #[inline(always)]
    pub fn lerp_weighted(self, other: Self, t: f32) -> Self {
    ...
    /// and is more numerically stable when interpolating large values that are far away from each other.
    #[inline(always)]
    pub fn lerp_unclamped(self, other: Self, t: f32) -> Self {
        self + (other - self) * t
    }
    ...
    /// This weighted formula is more numerically stable when interpolating large values that are far away from each other.
    #[inline(always)]
    pub fn lerp_unclamped_weighted(self, other: Self, t: f32) -> Self {
        self * (1.0 - t) + other * t
    }
