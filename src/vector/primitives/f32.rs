    ...
    Usize<N>: VecLen,
{
    ...
    #[inline(always)]
    pub fn div_euclid(self, other: Vector<N, f32, impl VecAlignment>) -> Self {
    ...
    #[inline(always)]
    pub fn rem_euclid(self, other: Vector<N, f32, impl VecAlignment>) -> Self {
    ...
    #[inline(always)]
    pub fn distance_sq(self, other: Vector<N, f32, impl VecAlignment>) -> f32 {
        (self - other).mag_sq()
    }
...
impl ScalarZero for f32 {
    ...
    const VEC2_ZERO: Vec2<f32> = Vec2::<f32>::const_from_array([0.0; 2]);
    const VEC3_ZERO: Vec3<f32> = Vec3::<f32>::const_from_array([0.0; 3]);
    const VEC4_ZERO: Vec4<f32> = Vec4::<f32>::const_from_array([0.0; 4]);
}

impl ScalarOne for f32 {
    const ONE: Self = 1.0;

    const VEC2_ONE: Vec2<f32> = Vec2::<f32>::const_from_array([1.0; 2]);
    const VEC3_ONE: Vec3<f32> = Vec3::<f32>::const_from_array([1.0; 3]);
    const VEC4_ONE: Vec4<f32> = Vec4::<f32>::const_from_array([1.0; 4]);

    const VEC2_X: Vec2<f32> = Vec2::<f32>::const_from_array([1.0, 0.0]);
    const VEC2_Y: Vec2<f32> = Vec2::<f32>::const_from_array([0.0, 1.0]);

    const VEC3_X: Vec3<f32> = Vec3::<f32>::const_from_array([1.0, 0.0, 0.0]);
    const VEC3_Y: Vec3<f32> = Vec3::<f32>::const_from_array([0.0, 1.0, 0.0]);
    const VEC3_Z: Vec3<f32> = Vec3::<f32>::const_from_array([0.0, 0.0, 1.0]);

    const VEC4_X: Vec4<f32> = Vec4::<f32>::const_from_array([1.0, 0.0, 0.0, 0.0]);
    const VEC4_Y: Vec4<f32> = Vec4::<f32>::const_from_array([0.0, 1.0, 0.0, 0.0]);
    const VEC4_Z: Vec4<f32> = Vec4::<f32>::const_from_array([0.0, 0.0, 1.0, 0.0]);
    const VEC4_W: Vec4<f32> = Vec4::<f32>::const_from_array([0.0, 0.0, 0.0, 1.0]);
}

impl ScalarNegOne for f32 {
    const NEG_ONE: Self = -1.0;

    const VEC2_NEG_ONE: Vec2<f32> = Vec2::<f32>::const_from_array([-1.0; 2]);
    const VEC3_NEG_ONE: Vec3<f32> = Vec3::<f32>::const_from_array([-1.0; 3]);
    const VEC4_NEG_ONE: Vec4<f32> = Vec4::<f32>::const_from_array([-1.0; 4]);

    const VEC2_NEG_X: Vec2<f32> = Vec2::<f32>::const_from_array([-1.0, 0.0]);
    const VEC2_NEG_Y: Vec2<f32> = Vec2::<f32>::const_from_array([0.0, -1.0]);

    const VEC3_NEG_X: Vec3<f32> = Vec3::<f32>::const_from_array([-1.0, 0.0, 0.0]);
    const VEC3_NEG_Y: Vec3<f32> = Vec3::<f32>::const_from_array([0.0, -1.0, 0.0]);
    const VEC3_NEG_Z: Vec3<f32> = Vec3::<f32>::const_from_array([0.0, 0.0, -1.0]);

    const VEC4_NEG_X: Vec4<f32> = Vec4::<f32>::const_from_array([-1.0, 0.0, 0.0, 0.0]);
    const VEC4_NEG_Y: Vec4<f32> = Vec4::<f32>::const_from_array([0.0, -1.0, 0.0, 0.0]);
    const VEC4_NEG_Z: Vec4<f32> = Vec4::<f32>::const_from_array([0.0, 0.0, -1.0, 0.0]);
    const VEC4_NEG_W: Vec4<f32> = Vec4::<f32>::const_from_array([0.0, 0.0, 0.0, -1.0]);
}
