    ...
    Length<N>: SupportedLength,
{
    ...
    pub fn max(self, other: Self) -> Self {
        specialize!(<T as UintBackend<N, A>>::vec_max(self, other))
    }
    ...
    pub fn checked_add(self, rhs: Self) -> Option<Self> {
        specialize!(<T as UintBackend<N, A>>::vec_checked_add(self, rhs))
    }
    ...
    pub fn checked_sub(self, rhs: Self) -> Option<Self> {
        specialize!(<T as UintBackend<N, A>>::vec_checked_sub(self, rhs))
    }
    ...
    pub fn checked_mul(self, rhs: Self) -> Option<Self> {
        specialize!(<T as UintBackend<N, A>>::vec_checked_mul(self, rhs))
    }
    ...
    pub fn checked_div(self, rhs: Self) -> Option<Self> {
        specialize!(<T as UintBackend<N, A>>::vec_checked_div(self, rhs))
    }
    ...
    pub fn checked_rem(self, rhs: Self) -> Option<Self> {
        specialize!(<T as UintBackend<N, A>>::vec_checked_rem(self, rhs))
    }
    ...
    pub fn saturating_add(self, rhs: Self) -> Self {
        specialize!(<T as UintBackend<N, A>>::vec_saturating_add(self, rhs))
    }
    ...
    pub fn saturating_sub(self, rhs: Self) -> Self {
        specialize!(<T as UintBackend<N, A>>::vec_saturating_sub(self, rhs))
    }
    ...
    pub fn saturating_mul(self, rhs: Self) -> Self {
        specialize!(<T as UintBackend<N, A>>::vec_saturating_mul(self, rhs))
    }
    ...
    pub fn wrapping_add(self, rhs: Self) -> Self {
        specialize!(<T as UintBackend<N, A>>::vec_wrapping_add(self, rhs))
    }
    ...
    pub fn wrapping_sub(self, rhs: Self) -> Self {
        specialize!(<T as UintBackend<N, A>>::vec_wrapping_sub(self, rhs))
    }
    ...
    pub fn wrapping_mul(self, rhs: Self) -> Self {
        specialize!(<T as UintBackend<N, A>>::vec_wrapping_mul(self, rhs))
    }
}

pub(crate) trait UintBackend<const N: usize, A: Alignment>: Scalar
where
    Length<N>: SupportedLength,
{
    #[inline]
