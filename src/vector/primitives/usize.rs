    ...
    Usize<N>: VecLen,
{
    ...
    #[inline(always)]
    pub const fn const_splat(value: usize) -> Self {
...
impl Scalar for usize {
    ...
    #[inline(always)]
    fn vec2_as_array(vec: Vec2<usize>) -> [usize; 2] {
        vec.0
    }

    #[inline(always)]
    fn vec3_from_array(array: [usize; 3]) -> Vec3<usize> {
        Vector(array)
    }

    #[inline(always)]
    fn vec3_as_array(vec: Vec3<usize>) -> [usize; 3] {
        vec.0
    }

    #[inline(always)]
    fn vec4_from_array(array: [usize; 4]) -> Vec4<usize> {
        Vector(array)
    }

    #[inline(always)]
    fn vec4_as_array(vec: Vec4<usize>) -> [usize; 4] {
        vec.0
    }
}
...
impl ScalarZero for usize {
    ...
    const VEC2_ZERO: Vec2<usize> = Vec2::<usize>::const_from_array([0; 2]);
    const VEC3_ZERO: Vec3<usize> = Vec3::<usize>::const_from_array([0; 3]);
    const VEC4_ZERO: Vec4<usize> = Vec4::<usize>::const_from_array([0; 4]);
}

impl ScalarOne for usize {
    const ONE: Self = 1;

    const VEC2_ONE: Vec2<usize> = Vec2::<usize>::const_from_array([1; 2]);
    const VEC3_ONE: Vec3<usize> = Vec3::<usize>::const_from_array([1; 3]);
    const VEC4_ONE: Vec4<usize> = Vec4::<usize>::const_from_array([1; 4]);

    const VEC2_X: Vec2<usize> = Vec2::<usize>::const_from_array([1, 0]);

    const VEC2_Y: Vec2<usize> = Vec2::<usize>::const_from_array([0, 1]);

    const VEC3_X: Vec3<usize> = Vec3::<usize>::const_from_array([1, 0, 0]);

    const VEC3_Y: Vec3<usize> = Vec3::<usize>::const_from_array([0, 1, 0]);

    const VEC3_Z: Vec3<usize> = Vec3::<usize>::const_from_array([0, 0, 1]);

    const VEC4_X: Vec4<usize> = Vec4::<usize>::const_from_array([1, 0, 0, 0]);

    const VEC4_Y: Vec4<usize> = Vec4::<usize>::const_from_array([0, 1, 0, 0]);

    const VEC4_Z: Vec4<usize> = Vec4::<usize>::const_from_array([0, 0, 1, 0]);

    const VEC4_W: Vec4<usize> = Vec4::<usize>::const_from_array([0, 0, 0, 1]);
}
