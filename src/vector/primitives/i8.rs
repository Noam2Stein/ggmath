            ...
            if S::IS_SIMD {
                match N {
                    2 => {
                        ...
                        transmute_copy::<Vector<2, i8, Simd>, Vector<N, i8, S>>(&vec)
                    }
                    3 => {
                        let array = transmute_copy::<[i8; N], [i8; 3]>(&array);
                        let vec = Vector::<3, _, _>(array);

                        transmute_copy::<Vector<3, i8, Simd>, Vector<N, i8, S>>(&vec)
                    }
                    4 => {
                        let array = transmute_copy::<[i8; N], [i8; 4]>(&array);
                        let vec = Vector::<4, _, _>(array);

                        transmute_copy::<Vector<4, i8, Simd>, Vector<N, i8, S>>(&vec)
                    }
                    _ => panic!("unusual vector type"),
                }
            } else {
                transmute_copy::<Vector<N, i8, NonSimd>, Vector<N, i8, S>>(&Vector(array))
            }
        }
    }
...
impl Scalar for i8 {
    type InnerSimdVec2 = [i8; 2];
    type InnerSimdVec3 = [i8; 3];
    type InnerSimdVec4 = [i8; 4];
