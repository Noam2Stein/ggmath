...
impl ScalarZero for u16 {
    ...
    const VEC2_ZERO: Vec2<u16> = Vec2::const_from_array([0; 2]);
    const VEC3_ZERO: Vec3<u16> = Vec3::const_from_array([0; 3]);
    const VEC4_ZERO: Vec4<u16> = Vec4::const_from_array([0; 4]);
}

impl ScalarOne for u16 {
    const ONE: Self = 1;

    const VEC2_ONE: Vec2<u16> = Vec2::const_from_array([1; 2]);
    const VEC3_ONE: Vec3<u16> = Vec3::const_from_array([1; 3]);
    const VEC4_ONE: Vec4<u16> = Vec4::const_from_array([1; 4]);

    const VEC2_x: Vec2<u16> = Vec2::const_from_array([1, 0]);

    const VEC2_y: Vec2<u16> = Vec2::const_from_array([0, 1]);

    const VEC3_x: Vec3<u16> = Vec3::const_from_array([1, 0, 0]);

    const VEC3_y: Vec3<u16> = Vec3::const_from_array([0, 1, 0]);

    const VEC3_z: Vec3<u16> = Vec3::const_from_array([0, 0, 1]);

    const VEC4_x: Vec4<u16> = Vec4::const_from_array([1, 0, 0, 0]);

    const VEC4_y: Vec4<u16> = Vec4::const_from_array([0, 1, 0, 0]);

    const VEC4_z: Vec4<u16> = Vec4::const_from_array([0, 0, 1, 0]);

    const VEC4_w: Vec4<u16> = Vec4::const_from_array([0, 0, 0, 1]);
}
