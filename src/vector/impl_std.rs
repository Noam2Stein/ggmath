...
impl<const N: usize, T: Scalar + Neg<Output: Scalar>, A: VecAlignment> Neg
for Vector<N, T, A>
where
    Usize<N>: VecLen,
{
...
impl<const N: usize, T: Scalar + Not<Output: Scalar>, A: VecAlignment> Not
for Vector<N, T, A>
where
    Usize<N>: VecLen,
{
    ...
    Usize<N>: VecLen,
{
    type Output = Vector<N, T::Output, A>;
    #[inline(always)]
    fn add(self, rhs: Vector<N, T2, A2>) -> Vector<N, <T as Add<T2>>::Output, A> {
        T::vec_add(self, rhs)
    }
}
impl<
    ...
    Usize<N>: VecLen,
{
    type Output = Vector<N, T::Output, A>;
    #[inline(always)]
    fn sub(self, rhs: Vector<N, T2, A2>) -> Vector<N, <T as Sub<T2>>::Output, A> {
        T::vec_sub(self, rhs)
    }
}
impl<
    ...
    Usize<N>: VecLen,
{
    type Output = Vector<N, T::Output, A>;
    #[inline(always)]
    fn mul(self, rhs: Vector<N, T2, A2>) -> Vector<N, <T as Mul<T2>>::Output, A> {
        T::vec_mul(self, rhs)
    }
}
impl<
    ...
    Usize<N>: VecLen,
{
    type Output = Vector<N, T::Output, A>;
    #[inline(always)]
    fn div(self, rhs: Vector<N, T2, A2>) -> Vector<N, <T as Div<T2>>::Output, A> {
        T::vec_div(self, rhs)
    }
}
impl<
    ...
    Usize<N>: VecLen,
{
    type Output = Vector<N, T::Output, A>;
    #[inline(always)]
    fn rem(self, rhs: Vector<N, T2, A2>) -> Vector<N, <T as Rem<T2>>::Output, A> {
        T::vec_rem(self, rhs)
    }
}
impl<
    ...
    Usize<N>: VecLen,
{
    type Output = Vector<N, T::Output, A>;
    #[inline(always)]
    fn shl(self, rhs: Vector<N, T2, A2>) -> Vector<N, <T as Shl<T2>>::Output, A> {
        T::vec_shl(self, rhs)
    }
}
impl<
    ...
    Usize<N>: VecLen,
{
    type Output = Vector<N, T::Output, A>;
    #[inline(always)]
    fn shr(self, rhs: Vector<N, T2, A2>) -> Vector<N, <T as Shr<T2>>::Output, A> {
        T::vec_shr(self, rhs)
    }
}
impl<
    ...
    Usize<N>: VecLen,
{
    type Output = Vector<N, T::Output, A>;
    #[inline(always)]
    fn bitand(self, rhs: Vector<N, T2, A2>) -> Vector<N, <T as BitAnd<T2>>::Output, A> {
    ...
    Usize<N>: VecLen,
{
    type Output = Vector<N, T::Output, A>;
    #[inline(always)]
    fn bitor(self, rhs: Vector<N, T2, A2>) -> Vector<N, <T as BitOr<T2>>::Output, A> {
    ...
    Usize<N>: VecLen,
{
    type Output = Vector<N, T::Output, A>;
    #[inline(always)]
    fn bitxor(self, rhs: Vector<N, T2, A2>) -> Vector<N, <T as BitXor<T2>>::Output, A> {
    ...
    Usize<N>: VecLen,
{
    ...
    fn add_assign(&mut self, rhs: Vector<N, T2, A2>) {
        T::vec_add_assign_assign(self, rhs)
    }
}
impl<
    const N: usize,
    ...
    Usize<N>: VecLen,
{
    ...
    fn sub_assign(&mut self, rhs: Vector<N, T2, A2>) {
        T::vec_sub_assign_assign(self, rhs)
    }
}
impl<
    const N: usize,
    ...
    Usize<N>: VecLen,
{
    ...
    fn mul_assign(&mut self, rhs: Vector<N, T2, A2>) {
        T::vec_mul_assign_assign(self, rhs)
    }
}
impl<
    const N: usize,
    ...
    Usize<N>: VecLen,
{
    ...
    fn div_assign(&mut self, rhs: Vector<N, T2, A2>) {
        T::vec_div_assign_assign(self, rhs)
    }
}
impl<
    const N: usize,
    ...
    Usize<N>: VecLen,
{
    ...
    fn rem_assign(&mut self, rhs: Vector<N, T2, A2>) {
        T::vec_rem_assign_assign(self, rhs)
    }
}
impl<
    const N: usize,
    ...
    Usize<N>: VecLen,
{
    ...
    fn shl_assign(&mut self, rhs: Vector<N, T2, A2>) {
        T::vec_shl_assign_assign(self, rhs)
    }
}
impl<
    const N: usize,
    ...
    Usize<N>: VecLen,
{
    ...
    fn shr_assign(&mut self, rhs: Vector<N, T2, A2>) {
        T::vec_shr_assign_assign(self, rhs)
    }
}
impl<
    const N: usize,
    ...
    Usize<N>: VecLen,
{
    ...
    fn bitand_assign(&mut self, rhs: Vector<N, T2, A2>) {
        T::vec_bitand_assign_assign(self, rhs)
    }
}
impl<
    const N: usize,
    ...
    Usize<N>: VecLen,
{
    ...
    fn bitor_assign(&mut self, rhs: Vector<N, T2, A2>) {
        T::vec_bitor_assign_assign(self, rhs)
    }
}
impl<
    const N: usize,
    ...
    Usize<N>: VecLen,
{
    ...
    fn bitxor_assign(&mut self, rhs: Vector<N, T2, A2>) {
        T::vec_bitxor_assign_assign(self, rhs)
    }
}
