...
macro_rules! declare_swizzle_fns {
    ($($f:ident: [$x:ident, $y:ident]),*$(,)?) => {$(
        ...
        pub fn $f(self) -> Vector<2, T, A> {
            Vector::<2, T, A>::new(self.$x, self.$y)
        }
    )*};
    ...
    ($($f:ident: [$x:ident, $y:ident, $z:ident]),*$(,)?) => {$(
        ...
        pub fn $f(self) -> Vector<3, T, A> {
            Vector::<3, T, A>::new(self.$x, self.$y, self.$z)
        }
    )*};
    ...
    ($($f:ident: [$x:ident, $y:ident, $z:ident, $w:ident]),*$(,)?) => {$(
        ...
        pub fn $f(self) -> Vector<4, T, A> {
            Vector::<4, T, A>::new(self.$x, self.$y, self.$z, self.$w)
        }
    )*};
}
...
macro_rules! declare_with_swizzle_fns {
    ($($f:ident: [$x:ident]),*$(,)?) => {$(
        ...
        #[inline]
        #[must_use]
        pub fn $f(mut self, value: T) -> Self {
            self.$x = value;
            self
        }
    )*};
    ...
    ($($f:ident: [$x:ident, $y:ident]),*$(,)?) => {$(
        ...
        #[inline]
        #[must_use]
        pub fn $f(mut self, value: Vector<2, T, A>) -> Self {
            self.$x = value.x;
            self.$y = value.y;
            self
        }
    ...
    ($($f:ident: [$x:ident, $y:ident, $z:ident]),*$(,)?) => {$(
        ...
        #[inline]
        #[must_use]
        pub fn $f(mut self, value: Vector<3, T, A>) -> Self {
            self.$x = value.x;
            self.$y = value.y;
            self.$z = value.z;
            self
    ...
    ($($f:ident: [$x:ident, $y:ident, $z:ident, $w:ident]),*$(,)?) => {$(
        ...
        #[inline]
        #[must_use]
        pub fn $f(mut self, value: Vector<4, T, A>) -> Self {
            self.$x = value.x;
            self.$y = value.y;
            self.$z = value.z;
            self.$w = value.w;
