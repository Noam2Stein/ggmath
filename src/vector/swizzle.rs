...
impl<T: Scalar, A: VecAlignment> Vector<2, T, A> {
	...
	pub const fn x_y_mut(&mut self) -> (&mut T, &mut T) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(0), &mut *self.as_mut_ptr().add(1))
	    }
	}
...
impl<T: Scalar, A: VecAlignment> Vector<3, T, A> {
	...
	pub const fn x_y_z_mut(&mut self) -> (&mut T, &mut T, &mut T) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(0), &mut *self.as_mut_ptr().add(1), &mut *self.as_mut_ptr().add(2))
	    }
	}
	...
	pub const fn x_yz_mut(&mut self) -> (&mut T, &mut Vector<2, T, VecPacked>) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(0), &mut *(self.as_mut_ptr().add(1) as *mut Vector<_, _, _>))
	    }
	}
	...
	pub const fn x_z_mut(&mut self) -> (&mut T, &mut T) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(0), &mut *self.as_mut_ptr().add(2))
	    }
	}
	...
	pub const fn xy_z_mut(&mut self) -> (&mut Vector<2, T, VecPacked>, &mut T) {
	    unsafe {
	        (&mut *(self.as_mut_ptr().add(0) as *mut Vector<_, _, _>), &mut *self.as_mut_ptr().add(2))
	    }
	}
	...
	pub const fn y_z_mut(&mut self) -> (&mut T, &mut T) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(1), &mut *self.as_mut_ptr().add(2))
	    }
	}
...
impl<T: Scalar, A: VecAlignment> Vector<4, T, A> {
	...
	pub const fn x_y_z_w_mut(&mut self) -> (&mut T, &mut T, &mut T, &mut T) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(0), &mut *self.as_mut_ptr().add(1), &mut *self.as_mut_ptr().add(2), &mut *self.as_mut_ptr().add(3))
	    }
	}
	...
	pub const fn x_y_zw_mut(&mut self) -> (&mut T, &mut T, &mut Vector<2, T, VecPacked>) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(0), &mut *self.as_mut_ptr().add(1), &mut *(self.as_mut_ptr().add(2) as *mut Vector<_, _, _>))
	    }
	}
	...
	pub const fn x_y_w_mut(&mut self) -> (&mut T, &mut T, &mut T) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(0), &mut *self.as_mut_ptr().add(1), &mut *self.as_mut_ptr().add(3))
	    }
	}
	...
	pub const fn x_yz_w_mut(&mut self) -> (&mut T, &mut Vector<2, T, VecPacked>, &mut T) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(0), &mut *(self.as_mut_ptr().add(1) as *mut Vector<_, _, _>), &mut *self.as_mut_ptr().add(3))
	    }
	}
	...
	pub const fn x_z_w_mut(&mut self) -> (&mut T, &mut T, &mut T) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(0), &mut *self.as_mut_ptr().add(2), &mut *self.as_mut_ptr().add(3))
	    }
	}
	...
	pub const fn x_zw_mut(&mut self) -> (&mut T, &mut Vector<2, T, VecPacked>) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(0), &mut *(self.as_mut_ptr().add(2) as *mut Vector<_, _, _>))
	    }
	}
	...
	pub const fn x_w_mut(&mut self) -> (&mut T, &mut T) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(0), &mut *self.as_mut_ptr().add(3))
	    }
	}
	...
	pub const fn xy_z_w_mut(&mut self) -> (&mut Vector<2, T, VecPacked>, &mut T, &mut T) {
	    unsafe {
	        (&mut *(self.as_mut_ptr().add(0) as *mut Vector<_, _, _>), &mut *self.as_mut_ptr().add(2), &mut *self.as_mut_ptr().add(3))
	    }
	}
	...
	/// - the `z` and `w` (3rd and 4th) components.
	#[inline(always)]
	pub const fn xy_zw_mut(&mut self) -> (&mut Vector<2, T, VecPacked>, &mut Vector<2, T, VecPacked>) {
	    unsafe {
	        (&mut *(self.as_mut_ptr().add(0) as *mut Vector<_, _, _>), &mut *(self.as_mut_ptr().add(2) as *mut Vector<_, _, _>))
	    }
	}
	...
	pub const fn xy_w_mut(&mut self) -> (&mut Vector<2, T, VecPacked>, &mut T) {
	    unsafe {
	        (&mut *(self.as_mut_ptr().add(0) as *mut Vector<_, _, _>), &mut *self.as_mut_ptr().add(3))
	    }
	}
	...
	pub const fn y_z_w_mut(&mut self) -> (&mut T, &mut T, &mut T) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(1), &mut *self.as_mut_ptr().add(2), &mut *self.as_mut_ptr().add(3))
	    }
	}
	...
	pub const fn y_zw_mut(&mut self) -> (&mut T, &mut Vector<2, T, VecPacked>) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(1), &mut *(self.as_mut_ptr().add(2) as *mut Vector<_, _, _>))
	    }
	}
	...
	pub const fn y_w_mut(&mut self) -> (&mut T, &mut T) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(1), &mut *self.as_mut_ptr().add(3))
	    }
	}
	...
	pub const fn yz_w_mut(&mut self) -> (&mut Vector<2, T, VecPacked>, &mut T) {
	    unsafe {
	        (&mut *(self.as_mut_ptr().add(1) as *mut Vector<_, _, _>), &mut *self.as_mut_ptr().add(3))
	    }
	}
	...
	pub const fn z_w_mut(&mut self) -> (&mut T, &mut T) {
	    unsafe {
	        (&mut *self.as_mut_ptr().add(2), &mut *self.as_mut_ptr().add(3))
	    }
	}
