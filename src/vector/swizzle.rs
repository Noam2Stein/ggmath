...
use crate::{Scalar, Vec2P, Vec3P, Vec4P, VecAligned, VecAlignment, Vector, specialize};
...
impl<T: Scalar, A: VecAlignment> Vector<2, T, A> {
    ...
    fn swizzle2<const X_SRC: usize, const Y_SRC: usize>(self) -> Vector<2, T, A> {
        specialize! {
            (self: Vector<2, T, A>) -> Vector<2, T, A>:
    ...
    fn swizzle3<const X_SRC: usize, const Y_SRC: usize, const Z_SRC: usize>(
        ...
        specialize! {
            (self: Vector<2, T, A>) -> Vector<3, T, A>:
    ...
    fn swizzle4<const X_SRC: usize, const Y_SRC: usize, const Z_SRC: usize, const W_SRC: usize>(
        ...
        specialize! {
            (self: Vector<2, T, A>) -> Vector<4, T, A>:
    ...
    fn with_swizzle1<const DST: usize>(self, value: T) -> Self {
        specialize! {
            (self: Vector<2, T, A>, value: T) -> Vector<2, T, A>:

            for (Vector<2, T, VecAligned>, T) -> Vector<2, T, VecAligned> {
                |vec, value| T::vec2_with_swizzle1::<DST>(vec, value)
            }
            else {
                let mut output = self;
    ...
    #[inline(always)]
    fn with_swizzle2<const X_DST: usize, const Y_DST: usize>(
        self,
        ...
        specialize! {
            ...
            for (Vector<2, T, VecAligned>, Vector<2, T, VecAligned>) -> Vector<2, T, VecAligned> {
                |vec, value| T::vec2_with_swizzle2::<X_DST, Y_DST>(vec, value)
            }
            else {
                let mut output = self;
...
impl<T: Scalar, A: VecAlignment> Vector<3, T, A> {
    ...
    pub fn with_xyz(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<0, 1, 2>(value)
    }
    ...
    pub fn with_xzy(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<0, 2, 1>(value)
    }
    ...
    pub fn with_yxz(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<1, 0, 2>(value)
    }
    ...
    pub fn with_yzx(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<1, 2, 0>(value)
    }
    ...
    pub fn with_zxy(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<2, 0, 1>(value)
    }
    ...
    pub fn with_zyx(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<2, 1, 0>(value)
    }
    ...
    fn swizzle2<const X_SRC: usize, const Y_SRC: usize>(self) -> Vector<2, T, A> {
        specialize! {
            (self: Vector<3, T, A>) -> Vector<2, T, A>:
    ...
    fn swizzle3<const X_SRC: usize, const Y_SRC: usize, const Z_SRC: usize>(
        ...
        specialize! {
            (self: Vector<3, T, A>) -> Vector<3, T, A>:
    ...
    fn swizzle4<const X_SRC: usize, const Y_SRC: usize, const Z_SRC: usize, const W_SRC: usize>(
        ...
        specialize! {
            (self: Vector<3, T, A>) -> Vector<4, T, A>:
    ...
    fn with_swizzle1<const DST: usize>(self, value: T) -> Self {
        specialize! {
            (self: Vector<3, T, A>, value: T) -> Vector<3, T, A>:

            for (Vector<3, T, VecAligned>, T) -> Vector<3, T, VecAligned> {
                |vec, value| T::vec3_with_swizzle1::<DST>(vec, value)
            }
            else {
                let mut output = self;
                output.set(DST, value);
    ...
    fn with_swizzle2<const X_DST: usize, const Y_DST: usize>(
        ...
        specialize! {
            ...
            for (Vector<3, T, VecAligned>, Vector<2, T, VecAligned>) -> Vector<3, T, VecAligned> {
                |vec, value| T::vec3_with_swizzle2::<X_DST, Y_DST>(vec, value)
            }
            else {
                let mut output = self;
                output.set(X_DST, value.x());
    ...
    #[inline(always)]
    fn with_swizzle3<const X_DST: usize, const Y_DST: usize, const Z_DST: usize>(
        self,
        ...
        specialize! {
            ...
            for (Vector<3, T, VecAligned>, Vector<3, T, VecAligned>) -> Vector<3, T, VecAligned> {
                |vec, value| T::vec3_with_swizzle3::<X_DST, Y_DST, Z_DST>(vec, value)
            }
            else {
                let mut output = self;
                output.set(X_DST, value.x());
...
impl<T: Scalar, A: VecAlignment> Vector<4, T, A> {
    ...
    pub fn with_xyw(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<0, 1, 3>(value)
    }
    ...
    pub fn with_xzw(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<0, 2, 3>(value)
    }
    ...
    pub fn with_xwy(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<0, 3, 1>(value)
    }
    ...
    pub fn with_xwz(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<0, 3, 2>(value)
    }
    ...
    pub fn with_yxw(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<1, 0, 3>(value)
    }
    ...
    pub fn with_yzw(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<1, 2, 3>(value)
    }
    ...
    pub fn with_ywx(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<1, 3, 0>(value)
    }
    ...
    pub fn with_ywz(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<1, 3, 2>(value)
    }
    ...
    pub fn with_zxw(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<2, 0, 3>(value)
    }
    ...
    pub fn with_zyw(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<2, 1, 3>(value)
    }
    ...
    pub fn with_zwx(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<2, 3, 0>(value)
    }
    ...
    pub fn with_zwy(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<2, 3, 1>(value)
    }
    ...
    pub fn with_wxy(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<3, 0, 1>(value)
    }
    ...
    pub fn with_wxz(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<3, 0, 2>(value)
    }
    ...
    pub fn with_wyx(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<3, 1, 0>(value)
    }
    ...
    pub fn with_wyz(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<3, 1, 2>(value)
    }
    ...
    pub fn with_wzx(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<3, 2, 0>(value)
    }
    ...
    pub fn with_wzy(self, value: Vector<3, T, impl VecAlignment>) -> Self {
        self.with_swizzle3::<3, 2, 1>(value)
    }
    ...
    pub fn with_xyzw(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<0, 1, 2, 3>(value)
    }
    ...
    pub fn with_xywz(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<0, 1, 3, 2>(value)
    }
    ...
    pub fn with_xzyw(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<0, 2, 1, 3>(value)
    }
    ...
    pub fn with_xzwy(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<0, 2, 3, 1>(value)
    }
    ...
    pub fn with_xwyz(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<0, 3, 1, 2>(value)
    }
    ...
    pub fn with_xwzy(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<0, 3, 2, 1>(value)
    }
    ...
    pub fn with_yxzw(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<1, 0, 2, 3>(value)
    }
    ...
    pub fn with_yxwz(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<1, 0, 3, 2>(value)
    }
    ...
    pub fn with_yzxw(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<1, 2, 0, 3>(value)
    }
    ...
    pub fn with_yzwx(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<1, 2, 3, 0>(value)
    }
    ...
    pub fn with_ywxz(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<1, 3, 0, 2>(value)
    }
    ...
    pub fn with_ywzx(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<1, 3, 2, 0>(value)
    }
    ...
    pub fn with_zxyw(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<2, 0, 1, 3>(value)
    }
    ...
    pub fn with_zxwy(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<2, 0, 3, 1>(value)
    }
    ...
    pub fn with_zyxw(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<2, 1, 0, 3>(value)
    }
    ...
    pub fn with_zywx(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<2, 1, 3, 0>(value)
    }
    ...
    pub fn with_zwxy(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<2, 3, 0, 1>(value)
    }
    ...
    pub fn with_zwyx(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<2, 3, 1, 0>(value)
    }
    ...
    pub fn with_wxyz(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<3, 0, 1, 2>(value)
    }
    ...
    pub fn with_wxzy(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<3, 0, 2, 1>(value)
    }
    ...
    pub fn with_wyxz(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<3, 1, 0, 2>(value)
    }
    ...
    pub fn with_wyzx(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<3, 1, 2, 0>(value)
    }
    ...
    pub fn with_wzxy(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<3, 2, 0, 1>(value)
    }
    ...
    pub fn with_wzyx(self, value: Vector<4, T, impl VecAlignment>) -> Self {
        self.with_swizzle4::<3, 2, 1, 0>(value)
    }
    ...
    fn swizzle2<const X_SRC: usize, const Y_SRC: usize>(self) -> Vector<2, T, A> {
        specialize! {
            (self: Vector<4, T, A>) -> Vector<2, T, A>:
    ...
    fn swizzle3<const X_SRC: usize, const Y_SRC: usize, const Z_SRC: usize>(
        ...
        specialize! {
            (self: Vector<4, T, A>) -> Vector<3, T, A>:
    ...
    fn swizzle4<const X_SRC: usize, const Y_SRC: usize, const Z_SRC: usize, const W_SRC: usize>(
        ...
        specialize! {
            (self: Vector<4, T, A>) -> Vector<4, T, A>:
    ...
    fn with_swizzle1<const DST: usize>(self, value: T) -> Self {
        specialize! {
            (self: Vector<4, T, A>, value: T) -> Vector<4, T, A>:

            for (Vector<4, T, VecAligned>, T) -> Vector<4, T, VecAligned> {
                |vec, value| T::vec4_with_swizzle1::<DST>(vec, value)
            }
            else {
                let mut output = self;
                output.set(DST, value);
    ...
    fn with_swizzle2<const X_DST: usize, const Y_DST: usize>(
        ...
        specialize! {
            ...
            for (Vector<4, T, VecAligned>, Vector<2, T, VecAligned>) -> Vector<4, T, VecAligned> {
                |vec, value| T::vec4_with_swizzle2::<X_DST, Y_DST>(vec, value)
            }
            else {
                let mut output = self;
                output.set(X_DST, value.x());
    ...
    fn with_swizzle3<const X_DST: usize, const Y_DST: usize, const Z_DST: usize>(
        ...
        specialize! {
            ...
            for (Vector<4, T, VecAligned>, Vector<3, T, VecAligned>) -> Vector<4, T, VecAligned> {
                |vec, value| T::vec4_with_swizzle3::<X_DST, Y_DST, Z_DST>(vec, value)
            }
            else {
                let mut output = self;
                output.set(X_DST, value.x());
    ...
    >(
        ...
        specialize! {
            ...
            for (Vector<4, T, VecAligned>, Vector<4, T, VecAligned>) -> Vector<4, T, VecAligned> {
                |vec, value| T::vec4_with_swizzle4::<X_DST, Y_DST, Z_DST, W_DST>(vec, value)
            }
            else {
                let mut output = self;
                output.set(X_DST, value.x());
