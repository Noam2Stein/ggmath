...
use crate::{Scalar, Simdness, Vec2S, Vec3S, Vec4S, Vector};
...
impl<T: Scalar> Vec2S<T> {
    ...
    #[inline(always)]
    pub const fn xy_mut(&mut self) -> &mut Vec2S<T> {
...
impl<T: Scalar> Vec3S<T> {
    ...
    #[inline(always)]
    pub const fn yz_ref(&self) -> &Vec2S<T> {
    ...
    #[inline(always)]
    pub const fn xyz_ref(&self) -> &Vec3S<T> {
    ...
    #[inline(always)]
    pub const fn yz_mut(&mut self) -> &mut Vec2S<T> {
    ...
    #[inline(always)]
    pub const fn xyz_mut(&mut self) -> &mut Vec3S<T> {
...
impl<T: Scalar> Vec4S<T> {
    ...
    #[inline(always)]
    pub const fn zw_ref(&self) -> &Vec2S<T> {
    ...
    #[inline(always)]
    pub const fn yzw_ref(&self) -> &Vec3S<T> {
    ...
    #[inline(always)]
    pub const fn xyzw_ref(&self) -> &Vec4S<T> {
    ...
    #[inline(always)]
    pub const fn zw_mut(&mut self) -> &mut Vec2S<T> {
    ...
    #[inline(always)]
    pub const fn yzw_mut(&mut self) -> &mut Vec3S<T> {
    ...
    #[inline(always)]
    pub const fn xyzw_mut(&mut self) -> &mut Vec4S<T> {
