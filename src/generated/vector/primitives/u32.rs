...
mod tests {
    ...
    fn test_array_aligned() {
        ...
        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).as_ptr(),
            [1, 2].as_ptr()
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).as_ptr(),
            [3, 4, 1].as_ptr()
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).as_ptr(),
            [2, 3, 4, 1].as_ptr()
        );

        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).as_mut_ptr(),
            [1, 2].as_mut_ptr()
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).as_mut_ptr(),
            [3, 4, 1].as_mut_ptr()
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).as_mut_ptr(),
            [2, 3, 4, 1].as_mut_ptr()
        );
        ...
        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2])
                .map(|x| {
        ...
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1])
                .map(|x| {
        ...
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1])
                .map(|x| {
        ...
        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).fold(|x, y| x + y),
            1 + 2
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).fold(|x, y| x + y),
            3 + 4 + 1
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).fold(|x, y| x + y),
            2 + 3 + 4 + 1
        );

        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).all(|x| x == 1),
            false
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).all(|x| x == 1),
            false
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).all(|x| x == 1),
            false
        );

        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).any(|x| x == 1),
            true
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).any(|x| x == 1),
            true
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).any(|x| x == 1),
            true
        );

        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).count(|x| x == 1),
            1
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).count(|x| x == 1),
            1
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).count(|x| x == 1),
            1
        );

        assert_eq!(Vector::<2, u32, VecAligned>::from_array([1, 2]).len(), 2);
        assert_eq!(Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).len(), 3);
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).len(),
            4
        );
    }
    ...
    fn test_storage_aligned() {
        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).align(),
            Vector::<2, u32, VecAligned>::from_array([1, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).align(),
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]),
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).align(),
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]),
        );

        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).pack(),
            Vector::<2, u32, VecPacked>::from_array([1, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).pack(),
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]),
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).pack(),
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]),
        );

        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).to_storage::<VecAligned>(),
            Vector::<2, u32, VecAligned>::from_array([1, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).to_storage::<VecAligned>(),
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]),
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).to_storage::<VecAligned>(),
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]),
        );

        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).to_storage::<VecPacked>(),
            Vector::<2, u32, VecPacked>::from_array([1, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).to_storage::<VecPacked>(),
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]),
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).to_storage::<VecPacked>(),
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]),
        );
    ...
    fn test_swizzle_aligned() {
        assert_eq!(Vector::<2, u32, VecAligned>::from_array([1, 2]).x(), 1);
        assert_eq!(Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).y(), 4);
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).z(),
            4
        );

        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).yy(),
            Vector::<2, u32, VecAligned>::from_array([2, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).zy(),
            Vector::<2, u32, VecAligned>::from_array([1, 4]),
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).xw(),
            Vector::<2, u32, VecAligned>::from_array([2, 1]),
        );

        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).xyy(),
            Vector::<3, u32, VecAligned>::from_array([1, 2, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).yzy(),
            Vector::<3, u32, VecAligned>::from_array([4, 1, 4]),
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).wxy(),
            Vector::<3, u32, VecAligned>::from_array([1, 2, 3]),
        );

        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).xxyy(),
            Vector::<4, u32, VecAligned>::from_array([1, 1, 2, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).yzyz(),
            Vector::<4, u32, VecAligned>::from_array([4, 1, 4, 1]),
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).wxyw(),
            Vector::<4, u32, VecAligned>::from_array([1, 2, 3, 1]),
        );
    }

    #[test]
    fn test_swizzle_ref_aligned() {
        assert_eq!(Vector::<2, u32, VecAligned>::from_array([1, 2]).x_ref(), &1);
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).y_ref(),
            &4
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).z_ref(),
            &4
        );

        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).xy_ref(),
            &Vector::<2, u32, VecPacked>::from_array([1, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([1, 2, 3]).yz_ref(),
            &Vector::<2, u32, VecPacked>::from_array([2, 3]),
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([1, 2, 3, 4]).zw_ref(),
            &Vector::<2, u32, VecPacked>::from_array([3, 4]),
        );

        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([1, 2, 3]).xyz_ref(),
            &Vector::<3, u32, VecPacked>::from_array([1, 2, 3]),
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([1, 2, 3, 4]).yzw_ref(),
            &Vector::<3, u32, VecPacked>::from_array([2, 3, 4]),
        );

        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([1, 2, 3, 4]).xyzw_ref(),
            &Vector::<4, u32, VecPacked>::from_array([1, 2, 3, 4]),
        );
    }
    ...
    fn test_swizzle_mut_aligned() {
        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).x_mut(),
            &mut 1
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).y_mut(),
            &mut 4
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).z_mut(),
            &mut 4
        );

        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).x_y_mut(),
            (&mut 1, &mut 2)
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).xy_z_mut(),
            (&mut Vector::<2, u32, VecPacked>::from_array([3, 4]), &mut 1)
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).xy_zw_mut(),
            (
                &mut Vector::<2, u32, VecPacked>::from_array([2, 3]),
                &mut Vector::<2, u32, VecPacked>::from_array([4, 1]),
            ),
        );
    }
    ...
    fn test_swizzle_with_aligned() {
        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).with_x(3),
            Vector::<2, u32, VecAligned>::from_array([3, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).with_y(2),
            Vector::<3, u32, VecAligned>::from_array([3, 2, 1]),
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).with_z(3),
            Vector::<4, u32, VecAligned>::from_array([2, 3, 3, 1]),
        );

        assert_eq!(
            Vector::<2, u32, VecAligned>::from_array([1, 2]).with_xy(vec2!(3, 4)),
            Vector::<2, u32, VecAligned>::from_array([3, 4]),
        );
        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]).with_zy(vec2!(2, 3)),
            Vector::<3, u32, VecAligned>::from_array([3, 3, 2]),
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).with_xw(vec2!(3, 4)),
            Vector::<4, u32, VecAligned>::from_array([3, 2, 3, 4]),
        );

        assert_eq!(
            Vector::<3, u32, VecAligned>::from_array([1, 2, 3]).with_xzy(vec3!(3, 4, 1)),
            Vector::<3, u32, VecAligned>::from_array([3, 1, 4]),
        );
        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).with_ywx(vec3!(3, 4, 1)),
            Vector::<4, u32, VecAligned>::from_array([1, 3, 4, 4]),
        );

        assert_eq!(
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]).with_xywz(vec4!(3, 4, 1, 2)),
            Vector::<4, u32, VecAligned>::from_array([3, 4, 2, 1]),
        );
    }
    ...
    fn test_swizzle_set_aligned() {
        assert_eq!(
            {
                let mut vector = Vector::<2, u32, VecAligned>::from_array([1, 2]);
                vector.set_x(3);
                vector
            },
            Vector::<2, u32, VecAligned>::from_array([3, 2]),
        ...
        assert_eq!(
            {
                let mut vector = Vector::<3, u32, VecAligned>::from_array([3, 4, 1]);
                vector.set_y(2);
                vector
            },
            Vector::<3, u32, VecAligned>::from_array([3, 2, 1]),
        ...
        assert_eq!(
            {
                let mut vector = Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]);
                vector.set_z(3);
                vector
            },
            Vector::<4, u32, VecAligned>::from_array([2, 3, 3, 1]),
        ...
        assert_eq!(
            {
                let mut vector = Vector::<3, u32, VecAligned>::from_array([1, 2, 3]);
    ...
    fn test_array_packed() {
        ...
        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).as_ptr(),
            [1, 2].as_ptr()
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).as_ptr(),
            [3, 4, 1].as_ptr()
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).as_ptr(),
            [2, 3, 4, 1].as_ptr()
        );

        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).as_mut_ptr(),
            [1, 2].as_mut_ptr()
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).as_mut_ptr(),
            [3, 4, 1].as_mut_ptr()
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).as_mut_ptr(),
            [2, 3, 4, 1].as_mut_ptr()
        );
        ...
        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).fold(|x, y| x + y),
            1 + 2
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).fold(|x, y| x + y),
            3 + 4 + 1
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).fold(|x, y| x + y),
            2 + 3 + 4 + 1
        );

        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).all(|x| x == 1),
            false
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).all(|x| x == 1),
            false
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).all(|x| x == 1),
            false
        );

        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).any(|x| x == 1),
            true
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).any(|x| x == 1),
            true
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).any(|x| x == 1),
            true
        );

        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).count(|x| x == 1),
            1
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).count(|x| x == 1),
            1
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).count(|x| x == 1),
            1
        );

        assert_eq!(Vector::<2, u32, VecPacked>::from_array([1, 2]).len(), 2);
        assert_eq!(Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).len(), 3);
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).len(),
            4
        );
    }
    ...
    fn test_storage_packed() {
        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).align(),
            Vector::<2, u32, VecAligned>::from_array([1, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).align(),
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]),
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).align(),
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]),
        );

        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).pack(),
            Vector::<2, u32, VecPacked>::from_array([1, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).pack(),
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]),
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).pack(),
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]),
        );

        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).to_storage::<VecAligned>(),
            Vector::<2, u32, VecAligned>::from_array([1, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).to_storage::<VecAligned>(),
            Vector::<3, u32, VecAligned>::from_array([3, 4, 1]),
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).to_storage::<VecAligned>(),
            Vector::<4, u32, VecAligned>::from_array([2, 3, 4, 1]),
        );

        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).to_storage::<VecPacked>(),
            Vector::<2, u32, VecPacked>::from_array([1, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).to_storage::<VecPacked>(),
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]),
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).to_storage::<VecPacked>(),
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]),
        );
    ...
    fn test_swizzle_packed() {
        assert_eq!(Vector::<2, u32, VecPacked>::from_array([1, 2]).x(), 1);
        assert_eq!(Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).y(), 4);
        assert_eq!(Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).z(), 4);

        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).yy(),
            Vector::<2, u32, VecPacked>::from_array([2, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).zy(),
            Vector::<2, u32, VecPacked>::from_array([1, 4]),
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).xw(),
            Vector::<2, u32, VecPacked>::from_array([2, 1]),
        );

        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).xyy(),
            Vector::<3, u32, VecPacked>::from_array([1, 2, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).yzy(),
            Vector::<3, u32, VecPacked>::from_array([4, 1, 4]),
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).wxy(),
            Vector::<3, u32, VecPacked>::from_array([1, 2, 3]),
        );

        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).xxyy(),
            Vector::<4, u32, VecPacked>::from_array([1, 1, 2, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).yzyz(),
            Vector::<4, u32, VecPacked>::from_array([4, 1, 4, 1]),
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).wxyw(),
            Vector::<4, u32, VecPacked>::from_array([1, 2, 3, 1]),
        );
    }

    #[test]
    fn test_swizzle_ref_packed() {
        assert_eq!(Vector::<2, u32, VecPacked>::from_array([1, 2]).x_ref(), &1);
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).y_ref(),
            &4
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).z_ref(),
            &4
        );

        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).xy_ref(),
            &Vector::<2, u32, VecPacked>::from_array([1, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([1, 2, 3]).yz_ref(),
            &Vector::<2, u32, VecPacked>::from_array([2, 3]),
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([1, 2, 3, 4]).zw_ref(),
            &Vector::<2, u32, VecPacked>::from_array([3, 4]),
        );

        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([1, 2, 3]).xyz_ref(),
            &Vector::<3, u32, VecPacked>::from_array([1, 2, 3]),
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([1, 2, 3, 4]).yzw_ref(),
            &Vector::<3, u32, VecPacked>::from_array([2, 3, 4]),
        );

        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([1, 2, 3, 4]).xyzw_ref(),
            &Vector::<4, u32, VecPacked>::from_array([1, 2, 3, 4]),
        );
    }
    ...
    fn test_swizzle_mut_packed() {
        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).x_mut(),
            &mut 1
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).y_mut(),
            &mut 4
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).z_mut(),
            &mut 4
        );

        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).x_y_mut(),
            (&mut 1, &mut 2)
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).xy_z_mut(),
            (&mut Vector::<2, u32, VecPacked>::from_array([3, 4]), &mut 1)
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).xy_zw_mut(),
            (
                &mut Vector::<2, u32, VecPacked>::from_array([2, 3]),
                &mut Vector::<2, u32, VecPacked>::from_array([4, 1]),
            ),
    ...
    fn test_swizzle_with_packed() {
        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).with_x(3),
            Vector::<2, u32, VecPacked>::from_array([3, 2]),
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).with_y(2),
            Vector::<3, u32, VecPacked>::from_array([3, 2, 1]),
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).with_z(3),
            Vector::<4, u32, VecPacked>::from_array([2, 3, 3, 1]),
        );

        assert_eq!(
            Vector::<2, u32, VecPacked>::from_array([1, 2]).with_xy(vec2!(3, 4)),
            Vector::<2, u32, VecPacked>::from_array([3, 4]),
        );
        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([3, 4, 1]).with_zy(vec2!(2, 3)),
            Vector::<3, u32, VecPacked>::from_array([3, 3, 2]),
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).with_xw(vec2!(3, 4)),
            Vector::<4, u32, VecPacked>::from_array([3, 2, 3, 4]),
        );

        assert_eq!(
            Vector::<3, u32, VecPacked>::from_array([1, 2, 3]).with_xzy(vec3!(3, 4, 1)),
            Vector::<3, u32, VecPacked>::from_array([3, 1, 4]),
        );
        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).with_ywx(vec3!(3, 4, 1)),
            Vector::<4, u32, VecPacked>::from_array([1, 3, 4, 4]),
        );

        assert_eq!(
            Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]).with_xywz(vec4!(3, 4, 1, 2)),
            Vector::<4, u32, VecPacked>::from_array([3, 4, 2, 1]),
        );
    }
    ...
    fn test_swizzle_set_packed() {
        assert_eq!(
            {
                let mut vector = Vector::<2, u32, VecPacked>::from_array([1, 2]);
                vector.set_x(3);
                vector
            },
            Vector::<2, u32, VecPacked>::from_array([3, 2]),
        ...
        assert_eq!(
            {
                let mut vector = Vector::<3, u32, VecPacked>::from_array([3, 4, 1]);
                vector.set_y(2);
                vector
            },
            Vector::<3, u32, VecPacked>::from_array([3, 2, 1]),
        ...
        assert_eq!(
            {
                let mut vector = Vector::<4, u32, VecPacked>::from_array([2, 3, 4, 1]);
                vector.set_z(3);
                vector
            },
            Vector::<4, u32, VecPacked>::from_array([2, 3, 3, 1]),
        ...
        assert_eq!(
            {
                let mut vector = Vector::<3, u32, VecPacked>::from_array([1, 2, 3]);
                vector.set_xzy(vec3!(3, 4, 1));
                vector
            },
            Vector::<3, u32, VecPacked>::from_array([3, 1, 4]),
