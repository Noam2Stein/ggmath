        ...
        if self.is_aligned() {
            unsafe {
                match self.len() {
                    2 => {
                        return Vector::<2, _, VecAligned>::from_inner(
                            self.transmute_vec2().inner.signum(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    3 => {
                        return Vector::<3, _, VecAligned>::from_inner(
                            self.transmute_vec3().inner.signum(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    4 => {
                        return Vector::<4, _, VecAligned>::from_inner(
                            self.transmute_vec4().inner.signum(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
        ...
        if self.is_aligned() {
            unsafe {
                match self.len() {
                    2 => {
                        return Vector::<2, _, VecAligned>::from_inner(
                            self.transmute_vec2().inner.is_nan_mask(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    3 => {
                        return Vector::<3, _, VecAligned>::from_inner(
                            self.transmute_vec3().inner.is_nan_mask(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    4 => {
                        return Vector::<4, _, VecAligned>::from_inner(
                            self.transmute_vec4().inner.is_nan_mask(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
        ...
        if self.is_aligned() {
            unsafe {
                match self.len() {
                    2 => {
                        return Vector::<2, _, VecAligned>::from_inner(
                            self.transmute_vec2().inner.is_finite_mask(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    3 => {
                        return Vector::<3, _, VecAligned>::from_inner(
                            self.transmute_vec3().inner.is_finite_mask(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    4 => {
                        return Vector::<4, _, VecAligned>::from_inner(
                            self.transmute_vec4().inner.is_finite_mask(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
        ...
        if self.is_aligned() {
            unsafe {
                match self.len() {
                    2 => {
                        return Vector::<2, _, VecAligned>::from_inner(
                            self.transmute_vec2().inner.round(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    3 => {
                        return Vector::<3, _, VecAligned>::from_inner(
                            self.transmute_vec3().inner.round(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    4 => {
                        return Vector::<4, _, VecAligned>::from_inner(
                            self.transmute_vec4().inner.round(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
        ...
        if self.is_aligned() {
            unsafe {
                match self.len() {
                    2 => {
                        return Vector::<2, _, VecAligned>::from_inner(
                            self.transmute_vec2().inner.trunc(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    3 => {
                        return Vector::<3, _, VecAligned>::from_inner(
                            self.transmute_vec3().inner.trunc(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    4 => {
                        return Vector::<4, _, VecAligned>::from_inner(
                            self.transmute_vec4().inner.trunc(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
        ...
        if self.is_aligned() {
            unsafe {
                match self.len() {
                    2 => {
                        return Vector::<2, _, VecAligned>::from_inner(
                            self.transmute_vec2().inner.floor(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    3 => {
                        return Vector::<3, _, VecAligned>::from_inner(
                            self.transmute_vec3().inner.floor(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    4 => {
                        return Vector::<4, _, VecAligned>::from_inner(
                            self.transmute_vec4().inner.floor(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
        ...
        if self.is_aligned() {
            unsafe {
                match self.len() {
                    2 => {
                        return Vector::<2, _, VecAligned>::from_inner(
                            self.transmute_vec2().inner.ceil(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    3 => {
                        return Vector::<3, _, VecAligned>::from_inner(
                            self.transmute_vec3().inner.ceil(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
                    4 => {
                        return Vector::<4, _, VecAligned>::from_inner(
                            self.transmute_vec4().inner.ceil(),
                        )
                        .transmute_len::<N>()
                        .transmute_alignment::<A>();
                    }
