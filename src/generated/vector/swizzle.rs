...
impl<T: Scalar, A: VecAlignment> Vector<2, T, A> {
	...
	pub fn xx(self) -> Vector<2, T, A> {
	    Vector::from_array([self[0], self[0]])
	}
	...
	pub fn xxxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[0], self[0]])
	}
	...
	pub fn xxxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[0], self[1]])
	}
	...
	pub fn xxyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[1], self[0]])
	}
	...
	pub fn xxyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[1], self[1]])
	}
	...
	pub fn xyxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[0], self[0]])
	}
	...
	pub fn xyxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[0], self[1]])
	}
	...
	pub fn xyyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[1], self[0]])
	}
	...
	pub fn xyyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[1], self[1]])
	}
	...
	pub fn yxxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[0], self[0]])
	}
	...
	pub fn yxxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[0], self[1]])
	}
	...
	pub fn yxyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[1], self[0]])
	}
	...
	pub fn yxyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[1], self[1]])
	}
	...
	pub fn yyxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[0], self[0]])
	}
	...
	pub fn yyxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[0], self[1]])
	}
	...
	pub fn yyyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[1], self[0]])
	}
	...
	pub fn yyyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[1], self[1]])
	}
...
impl<T: Scalar, A: VecAlignment> Vector<3, T, A> {
	...
	pub fn xz(self) -> Vector<2, T, A> {
	    Vector::from_array([self[0], self[2]])
	}
	...
	pub fn xxz(self) -> Vector<3, T, A> {
	    Vector::from_array([self[0], self[0], self[2]])
	}
	...
	pub fn yxz(self) -> Vector<3, T, A> {
	    Vector::from_array([self[1], self[0], self[2]])
	}
	...
	pub fn xxxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[0], self[2]])
	}
	...
	pub fn xxyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[1], self[2]])
	}
	...
	pub fn xxzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[2], self[0]])
	}
	...
	pub fn xxzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[2], self[1]])
	}
	...
	pub fn xxzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[2], self[2]])
	}
	...
	pub fn xyxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[0], self[2]])
	}
	...
	pub fn xyyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[1], self[2]])
	}
	...
	pub fn xyzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[2], self[0]])
	}
	...
	pub fn xyzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[2], self[1]])
	}
	...
	pub fn xyzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[2], self[2]])
	}
	...
	pub fn xzxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[0], self[0]])
	}
	...
	pub fn xzxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[0], self[1]])
	}
	...
	pub fn xzxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[0], self[2]])
	}
	...
	pub fn xzyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[1], self[0]])
	}
	...
	pub fn xzyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[1], self[1]])
	}
	...
	pub fn xzyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[1], self[2]])
	}
	...
	pub fn xzzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[2], self[0]])
	}
	...
	pub fn xzzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[2], self[1]])
	}
	...
	pub fn xzzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[2], self[2]])
	}
	...
	pub fn yxxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[0], self[2]])
	}
	...
	pub fn yxyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[1], self[2]])
	}
	...
	pub fn yxzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[2], self[0]])
	}
	...
	pub fn yxzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[2], self[1]])
	}
	...
	pub fn yxzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[2], self[2]])
	}
	...
	pub fn yyxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[0], self[2]])
	}
	...
	pub fn yyyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[1], self[2]])
	}
	...
	pub fn yyzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[2], self[0]])
	}
	...
	pub fn yyzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[2], self[1]])
	}
	...
	pub fn yyzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[2], self[2]])
	}
	...
	pub fn yzxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[0], self[0]])
	}
	...
	pub fn yzxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[0], self[1]])
	}
	...
	pub fn yzxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[0], self[2]])
	}
	...
	pub fn yzyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[1], self[0]])
	}
	...
	pub fn yzyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[1], self[1]])
	}
	...
	pub fn yzyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[1], self[2]])
	}
	...
	pub fn yzzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[2], self[0]])
	}
	...
	pub fn yzzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[2], self[1]])
	}
	...
	pub fn yzzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[2], self[2]])
	}
	...
	pub fn zxxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[0], self[0]])
	}
	...
	pub fn zxxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[0], self[1]])
	}
	...
	pub fn zxxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[0], self[2]])
	}
	...
	pub fn zxyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[1], self[0]])
	}
	...
	pub fn zxyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[1], self[1]])
	}
	...
	pub fn zxyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[1], self[2]])
	}
	...
	pub fn zxzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[2], self[0]])
	}
	...
	pub fn zxzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[2], self[1]])
	}
	...
	pub fn zxzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[2], self[2]])
	}
	...
	pub fn zyxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[0], self[0]])
	}
	...
	pub fn zyxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[0], self[1]])
	}
	...
	pub fn zyxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[0], self[2]])
	}
	...
	pub fn zyyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[1], self[0]])
	}
	...
	pub fn zyyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[1], self[1]])
	}
	...
	pub fn zyyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[1], self[2]])
	}
	...
	pub fn zyzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[2], self[0]])
	}
	...
	pub fn zyzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[2], self[1]])
	}
	...
	pub fn zyzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[2], self[2]])
	}
	...
	pub fn zzxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[0], self[0]])
	}
	...
	pub fn zzxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[0], self[1]])
	}
	...
	pub fn zzxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[0], self[2]])
	}
	...
	pub fn zzyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[1], self[0]])
	}
	...
	pub fn zzyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[1], self[1]])
	}
	...
	pub fn zzyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[1], self[2]])
	}
	...
	pub fn zzzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[2], self[0]])
	}
	...
	pub fn zzzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[2], self[1]])
	}
	...
	pub fn zzzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[2], self[2]])
	}
...
impl<T: Scalar, A: VecAlignment> Vector<4, T, A> {
	...
	pub fn xw(self) -> Vector<2, T, A> {
	    Vector::from_array([self[0], self[3]])
	}
	...
	pub fn yw(self) -> Vector<2, T, A> {
	    Vector::from_array([self[1], self[3]])
	}
	...
	pub fn xxw(self) -> Vector<3, T, A> {
	    Vector::from_array([self[0], self[0], self[3]])
	}
	...
	pub fn xyw(self) -> Vector<3, T, A> {
	    Vector::from_array([self[0], self[1], self[3]])
	}
	...
	pub fn yxw(self) -> Vector<3, T, A> {
	    Vector::from_array([self[1], self[0], self[3]])
	}
	...
	pub fn yyw(self) -> Vector<3, T, A> {
	    Vector::from_array([self[1], self[1], self[3]])
	}
	...
	pub fn zxw(self) -> Vector<3, T, A> {
	    Vector::from_array([self[2], self[0], self[3]])
	}
	...
	pub fn zyw(self) -> Vector<3, T, A> {
	    Vector::from_array([self[2], self[1], self[3]])
	}
	...
	pub fn xxxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[0], self[3]])
	}
	...
	pub fn xxyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[1], self[3]])
	}
	...
	pub fn xxzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[2], self[3]])
	}
	...
	pub fn xxwx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[3], self[0]])
	}
	...
	pub fn xxwy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[3], self[1]])
	}
	...
	pub fn xxwz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[3], self[2]])
	}
	...
	pub fn xxww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[0], self[3], self[3]])
	}
	...
	pub fn xyxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[0], self[3]])
	}
	...
	pub fn xyyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[1], self[3]])
	}
	...
	pub fn xywx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[3], self[0]])
	}
	...
	pub fn xywy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[3], self[1]])
	}
	...
	pub fn xywz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[3], self[2]])
	}
	...
	pub fn xyww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[1], self[3], self[3]])
	}
	...
	pub fn xzxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[0], self[3]])
	}
	...
	pub fn xzyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[1], self[3]])
	}
	...
	pub fn xzzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[2], self[3]])
	}
	...
	pub fn xzwx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[3], self[0]])
	}
	...
	pub fn xzwy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[3], self[1]])
	}
	...
	pub fn xzwz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[3], self[2]])
	}
	...
	pub fn xzww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[2], self[3], self[3]])
	}
	...
	pub fn xwxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[0], self[0]])
	}
	...
	pub fn xwxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[0], self[1]])
	}
	...
	pub fn xwxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[0], self[2]])
	}
	...
	pub fn xwxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[0], self[3]])
	}
	...
	pub fn xwyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[1], self[0]])
	}
	...
	pub fn xwyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[1], self[1]])
	}
	...
	pub fn xwyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[1], self[2]])
	}
	...
	pub fn xwyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[1], self[3]])
	}
	...
	pub fn xwzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[2], self[0]])
	}
	...
	pub fn xwzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[2], self[1]])
	}
	...
	pub fn xwzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[2], self[2]])
	}
	...
	pub fn xwzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[2], self[3]])
	}
	...
	pub fn xwwx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[3], self[0]])
	}
	...
	pub fn xwwy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[3], self[1]])
	}
	...
	pub fn xwwz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[3], self[2]])
	}
	...
	pub fn xwww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[0], self[3], self[3], self[3]])
	}
	...
	pub fn yxxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[0], self[3]])
	}
	...
	pub fn yxyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[1], self[3]])
	}
	...
	pub fn yxzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[2], self[3]])
	}
	...
	pub fn yxwx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[3], self[0]])
	}
	...
	pub fn yxwy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[3], self[1]])
	}
	...
	pub fn yxwz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[3], self[2]])
	}
	...
	pub fn yxww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[0], self[3], self[3]])
	}
	...
	pub fn yyxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[0], self[3]])
	}
	...
	pub fn yyyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[1], self[3]])
	}
	...
	pub fn yyzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[2], self[3]])
	}
	...
	pub fn yywx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[3], self[0]])
	}
	...
	pub fn yywy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[3], self[1]])
	}
	...
	pub fn yywz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[3], self[2]])
	}
	...
	pub fn yyww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[1], self[3], self[3]])
	}
	...
	pub fn yzxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[0], self[3]])
	}
	...
	pub fn yzyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[1], self[3]])
	}
	...
	pub fn yzzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[2], self[3]])
	}
	...
	pub fn yzwx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[3], self[0]])
	}
	...
	pub fn yzwy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[3], self[1]])
	}
	...
	pub fn yzwz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[3], self[2]])
	}
	...
	pub fn yzww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[2], self[3], self[3]])
	}
	...
	pub fn ywxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[0], self[0]])
	}
	...
	pub fn ywxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[0], self[1]])
	}
	...
	pub fn ywxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[0], self[2]])
	}
	...
	pub fn ywxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[0], self[3]])
	}
	...
	pub fn ywyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[1], self[0]])
	}
	...
	pub fn ywyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[1], self[1]])
	}
	...
	pub fn ywyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[1], self[2]])
	}
	...
	pub fn ywyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[1], self[3]])
	}
	...
	pub fn ywzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[2], self[0]])
	}
	...
	pub fn ywzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[2], self[1]])
	}
	...
	pub fn ywzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[2], self[2]])
	}
	...
	pub fn ywzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[2], self[3]])
	}
	...
	pub fn ywwx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[3], self[0]])
	}
	...
	pub fn ywwy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[3], self[1]])
	}
	...
	pub fn ywwz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[3], self[2]])
	}
	...
	pub fn ywww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[1], self[3], self[3], self[3]])
	}
	...
	pub fn zxxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[0], self[3]])
	}
	...
	pub fn zxyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[1], self[3]])
	}
	...
	pub fn zxzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[2], self[3]])
	}
	...
	pub fn zxwx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[3], self[0]])
	}
	...
	pub fn zxwy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[3], self[1]])
	}
	...
	pub fn zxwz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[3], self[2]])
	}
	...
	pub fn zxww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[0], self[3], self[3]])
	}
	...
	pub fn zyxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[0], self[3]])
	}
	...
	pub fn zyyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[1], self[3]])
	}
	...
	pub fn zyzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[2], self[3]])
	}
	...
	pub fn zywx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[3], self[0]])
	}
	...
	pub fn zywy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[3], self[1]])
	}
	...
	pub fn zywz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[3], self[2]])
	}
	...
	pub fn zyww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[1], self[3], self[3]])
	}
	...
	pub fn zzxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[0], self[3]])
	}
	...
	pub fn zzyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[1], self[3]])
	}
	...
	pub fn zzzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[2], self[3]])
	}
	...
	pub fn zzwx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[3], self[0]])
	}
	...
	pub fn zzwy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[3], self[1]])
	}
	...
	pub fn zzwz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[3], self[2]])
	}
	...
	pub fn zzww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[2], self[3], self[3]])
	}
	...
	pub fn zwxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[0], self[0]])
	}
	...
	pub fn zwxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[0], self[1]])
	}
	...
	pub fn zwxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[0], self[2]])
	}
	...
	pub fn zwxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[0], self[3]])
	}
	...
	pub fn zwyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[1], self[0]])
	}
	...
	pub fn zwyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[1], self[1]])
	}
	...
	pub fn zwyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[1], self[2]])
	}
	...
	pub fn zwyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[1], self[3]])
	}
	...
	pub fn zwzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[2], self[0]])
	}
	...
	pub fn zwzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[2], self[1]])
	}
	...
	pub fn zwzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[2], self[2]])
	}
	...
	pub fn zwzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[2], self[3]])
	}
	...
	pub fn zwwx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[3], self[0]])
	}
	...
	pub fn zwwy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[3], self[1]])
	}
	...
	pub fn zwwz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[3], self[2]])
	}
	...
	pub fn zwww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[2], self[3], self[3], self[3]])
	}
	...
	pub fn wxxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[0], self[0]])
	}
	...
	pub fn wxxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[0], self[1]])
	}
	...
	pub fn wxxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[0], self[2]])
	}
	...
	pub fn wxxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[0], self[3]])
	}
	...
	pub fn wxyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[1], self[0]])
	}
	...
	pub fn wxyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[1], self[1]])
	}
	...
	pub fn wxyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[1], self[2]])
	}
	...
	pub fn wxyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[1], self[3]])
	}
	...
	pub fn wxzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[2], self[0]])
	}
	...
	pub fn wxzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[2], self[1]])
	}
	...
	pub fn wxzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[2], self[2]])
	}
	...
	pub fn wxzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[2], self[3]])
	}
	...
	pub fn wxwx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[3], self[0]])
	}
	...
	pub fn wxwy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[3], self[1]])
	}
	...
	pub fn wxwz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[3], self[2]])
	}
	...
	pub fn wxww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[0], self[3], self[3]])
	}
	...
	pub fn wyxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[0], self[0]])
	}
	...
	pub fn wyxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[0], self[1]])
	}
	...
	pub fn wyxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[0], self[2]])
	}
	...
	pub fn wyxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[0], self[3]])
	}
	...
	pub fn wyyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[1], self[0]])
	}
	...
	pub fn wyyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[1], self[1]])
	}
	...
	pub fn wyyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[1], self[2]])
	}
	...
	pub fn wyyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[1], self[3]])
	}
	...
	pub fn wyzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[2], self[0]])
	}
	...
	pub fn wyzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[2], self[1]])
	}
	...
	pub fn wyzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[2], self[2]])
	}
	...
	pub fn wyzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[2], self[3]])
	}
	...
	pub fn wywx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[3], self[0]])
	}
	...
	pub fn wywy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[3], self[1]])
	}
	...
	pub fn wywz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[3], self[2]])
	}
	...
	pub fn wyww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[1], self[3], self[3]])
	}
	...
	pub fn wzxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[0], self[0]])
	}
	...
	pub fn wzxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[0], self[1]])
	}
	...
	pub fn wzxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[0], self[2]])
	}
	...
	pub fn wzxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[0], self[3]])
	}
	...
	pub fn wzyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[1], self[0]])
	}
	...
	pub fn wzyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[1], self[1]])
	}
	...
	pub fn wzyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[1], self[2]])
	}
	...
	pub fn wzyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[1], self[3]])
	}
	...
	pub fn wzzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[2], self[0]])
	}
	...
	pub fn wzzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[2], self[1]])
	}
	...
	pub fn wzzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[2], self[2]])
	}
	...
	pub fn wzzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[2], self[3]])
	}
	...
	pub fn wzwx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[3], self[0]])
	}
	...
	pub fn wzwy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[3], self[1]])
	}
	...
	pub fn wzwz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[3], self[2]])
	}
	...
	pub fn wzww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[2], self[3], self[3]])
	}
	...
	pub fn wwxx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[0], self[0]])
	}
	...
	pub fn wwxy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[0], self[1]])
	}
	...
	pub fn wwxz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[0], self[2]])
	}
	...
	pub fn wwxw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[0], self[3]])
	}
	...
	pub fn wwyx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[1], self[0]])
	}
	...
	pub fn wwyy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[1], self[1]])
	}
	...
	pub fn wwyz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[1], self[2]])
	}
	...
	pub fn wwyw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[1], self[3]])
	}
	...
	pub fn wwzx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[2], self[0]])
	}
	...
	pub fn wwzy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[2], self[1]])
	}
	...
	pub fn wwzz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[2], self[2]])
	}
	...
	pub fn wwzw(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[2], self[3]])
	}
	...
	pub fn wwwx(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[3], self[0]])
	}
	...
	pub fn wwwy(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[3], self[1]])
	}
	...
	pub fn wwwz(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[3], self[2]])
	}
	...
	pub fn wwww(self) -> Vector<4, T, A> {
	    Vector::from_array([self[3], self[3], self[3], self[3]])
	}
