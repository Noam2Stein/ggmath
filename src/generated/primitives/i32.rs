    ...
    Usize<N>: VecLen,
{
	...
	#[inline(always)]
	pub const fn add(mut self, other: Vector<N, i32, impl VecAlignment>) -> Self {
	    let mut i = 0;
	...
	#[inline(always)]
	pub const fn sub(mut self, other: Vector<N, i32, impl VecAlignment>) -> Self {
	    let mut i = 0;
	...
	#[inline(always)]
	pub const fn mul(mut self, other: Vector<N, i32, impl VecAlignment>) -> Self {
	    let mut i = 0;
	...
	#[inline(always)]
	pub const fn div(mut self, other: Vector<N, i32, impl VecAlignment>) -> Self {
	    let mut i = 0;
	...
	#[inline(always)]
	pub const fn rem(mut self, other: Vector<N, i32, impl VecAlignment>) -> Self {
	    let mut i = 0;
	...
	#[inline(always)]
	pub const fn and(mut self, other: Vector<N, i32, impl VecAlignment>) -> Self {
	    let mut i = 0;
	...
	#[inline(always)]
	pub const fn or(mut self, other: Vector<N, i32, impl VecAlignment>) -> Self {
	    let mut i = 0;
	...
	#[inline(always)]
	pub const fn xor(mut self, other: Vector<N, i32, impl VecAlignment>) -> Self {
	    let mut i = 0;
	...
	#[inline(always)]
	pub const fn shl(mut self, other: Vector<N, i32, impl VecAlignment>) -> Self {
	    let mut i = 0;
	...
	#[inline(always)]
	pub const fn shr(mut self, other: Vector<N, i32, impl VecAlignment>) -> Self {
	    let mut i = 0;
