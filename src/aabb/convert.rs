        ...
        unsafe {
            match R::ENUM {
                AabbReprEnum::Cornered => {
                    let inner =
                        transmute_copy::<Aabb<N, T, A, R>, Aabb<N, T, A, AabbCornered>>(&self)
                            .inner;

                    Aabb::from_min_size(inner.min, inner.size)
                }

                AabbReprEnum::Centered => {
                    let inner =
                        transmute_copy::<Aabb<N, T, A, R>, Aabb<N, T, A, AabbCentered>>(&self)
                            .inner;

                    Aabb::from_center_extents(inner.center, inner.extents)
                }

                AabbReprEnum::MinMaxed => {
                    let inner =
                        transmute_copy::<Aabb<N, T, A, R>, Aabb<N, T, A, AabbMinMaxed>>(&self)
                            .inner;

                    Aabb::from_min_max(inner.min, inner.max)
                }
            }
        }
    }
