...
/// #
/// let intrinsic = Mat3::from_euler(EulerRot::Yxz, y, x, z);
/// let other = Mat3::from_rotation_y(y) * Mat3::from_rotation_x(x) * Mat3::from_rotation_z(z);
/// assert!(intrinsic.abs_diff_eq(&other, 2e-6));
///
/// let extrinsic = Mat3::from_euler(EulerRot::YxzEx, y, x, z);
/// let other = Mat3::from_rotation_z(z) * Mat3::from_rotation_x(x) * Mat3::from_rotation_y(y);
