...
mod tests {
    ...
    use crate::{
        Rotor, Rotor2, Rotor3, Unaligned, Vec2, Vec4,
    ...
    fn test_from_lanes() {
        assert_eq!(
            Rotor3::<i32x4>::from_lanes(&[
                Rotor3::from_raw_elements(0, 1, 2, 3),
                Rotor3::from_raw_elements(10, 11, 12, 13),
                Rotor3::from_raw_elements(20, 21, 22, 23),
                Rotor3::from_raw_elements(30, 31, 32, 33),
            ]),
            Rotor3::from_raw_elements(
    ...
    #[test]
    fn test_lane() {
        let rotor = Rotor3::from_raw_elements(
            i32x4::new([0, 10, 20, 30]),
            i32x4::new([1, 11, 21, 31]),
            i32x4::new([2, 12, 22, 32]),
            i32x4::new([3, 13, 23, 33]),
        ...
        assert_eq!(rotor.lane(0), Rotor3::from_raw_elements(0, 1, 2, 3));
        assert_eq!(rotor.lane(1), Rotor3::from_raw_elements(10, 11, 12, 13));
        assert_eq!(rotor.lane(2), Rotor3::from_raw_elements(20, 21, 22, 23));
        assert_eq!(rotor.lane(3), Rotor3::from_raw_elements(30, 31, 32, 33));
        assert_panic!(rotor.lane(4));
    }

    #[test]
    fn test_set_lane() {
        let mut rotor = Rotor3::from_raw_elements(
            i32x4::new([0, 10, 20, 30]),
            i32x4::new([1, 11, 21, 31]),
            i32x4::new([2, 12, 22, 32]),
            i32x4::new([3, 13, 23, 33]),
        ...
        rotor.set_lane(0, Rotor3::from_raw_elements(-1, -2, -3, -4));
        assert_eq!(
            rotor,
            Rotor3::from_raw_elements(
        ...
        rotor.set_lane(1, Rotor3::from_raw_elements(-10, -11, -12, -13));
        assert_eq!(
            rotor,
            Rotor3::from_raw_elements(
                i32x4::new([-1, -10, 20, 30]),
        ...
        rotor.set_lane(2, Rotor3::from_raw_elements(-20, -21, -22, -23));
        assert_eq!(
            rotor,
            Rotor3::from_raw_elements(
                i32x4::new([-1, -10, -20, 30]),
        ...
        rotor.set_lane(3, Rotor3::from_raw_elements(-30, -31, -32, -33));
        assert_eq!(
            rotor,
            Rotor3::from_raw_elements(
                i32x4::new([-1, -10, -20, -30]),
    ...
    #[test]
    fn test_simd_eq() {
        for ([a, b], mask) in random_iter::<([Rotor2<i32x4>; 2], Vec2<i32x4>)>() {
            let b: Rotor2<i32x4> = Rotor(mask.negative_mask().select(a.0, b.0));
        ...
        for ([a, b], mask) in random_iter::<([Rotor3<i32x4>; 2], Vec4<i32x4>)>() {
            let b: Rotor3<i32x4> = Rotor(mask.negative_mask().select(a.0, b.0));
