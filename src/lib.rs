...
macro_rules! specialize {
    ...
    (@expand_tuple_into_closure $closure:ident($tuple:ident); ) => {
        $closure()
    };

    (@expand_tuple_into_closure $closure:ident($tuple:ident); $_type0:ty) => {
        $closure($tuple.0)
    };

    (@expand_tuple_into_closure $closure:ident($tuple:ident); $_type0:ty, $_type1:ty) => {
        $closure($tuple.0, $tuple.1)
    };

    (@expand_tuple_into_closure $closure:ident($tuple:ident); $_type0:ty, $_type1:ty, $_type2:ty) => {
        $closure($tuple.0, $tuple.1, $tuple.2)
    };

    (@expand_tuple_into_closure $closure:ident($tuple:ident); $_type0:ty, $_type1:ty, $_type2:ty, $_type3:ty) => {
        $closure($tuple.0, $tuple.1, $tuple.2, $tuple.3)
    };

    (@expand_tuple_into_closure $closure:ident($tuple:ident); $_type0:ty, $_type1:ty, $_type2:ty, $_type3:ty, $_type4:ty) => {
        $closure($tuple.0, $tuple.1, $tuple.2, $tuple.3, $tuple.4)
    };

    (@expand_tuple_into_closure $closure:ident($tuple:ident); $_type0:ty, $_type1:ty, $_type2:ty, $_type3:ty, $_type4:ty, $_type5:ty) => {
        $closure($tuple.0, $tuple.1, $tuple.2, $tuple.3, $tuple.4, $tuple.5)
    };

    (@expand_tuple_into_closure $closure:ident($tuple:ident); $_type0:ty, $_type1:ty, $_type2:ty, $_type3:ty, $_type4:ty, $_type5:ty, $_type6:ty) => {
        $closure($tuple.0, $tuple.1, $tuple.2, $tuple.3, $tuple.4, $tuple.5, $tuple.6)
    };
}
