...
#[doc=" An auto trait for types that can be sent anywhere anytime."]
#[doc=""]
#[doc=" This trait is required for all `ggmath` types,"]
#[doc=" like scalars, vectors, matrices, etc."]
pub trait Construct: Sized + Send + Sync + 'static + Copy + UnwindSafe + RefUnwindSafe {}

#[doc=" A simple marker type that is generic over a `usize` constant."]
#[doc=""]
#[doc=" This is used to implement traits for specific `usize` values."]
#[doc=" As is used in vectors with the [`VecLen`][vector::VecLen] trait."]
pub struct Usize<const N: usize>;

#[doc=" An error type for when an index is out of bounds."]
