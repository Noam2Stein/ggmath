...
vec_op!(Neg, neg, Vec3, x, y, z);
vec_op!(Not, not, Vec3, x, y, z);
vec_rhs_op!(Add, add, Vec3, x, y, z);
vec_assign_op!(AddAssign, add_assign, Vec3, x, y, z);
vec_rhs_op!(Sub, sub, Vec3, x, y, z);
vec_assign_op!(SubAssign, sub_assign, Vec3, x, y, z);
vec_rhs_op!(Mul, mul, Vec3, x, y, z);
vec_assign_op!(MulAssign, mul_assign, Vec3, x, y, z);
vec_rhs_op!(Div, div, Vec3, x, y, z);
vec_assign_op!(DivAssign, div_assign, Vec3, x, y, z);
vec_rhs_op!(Rem, rem, Vec3, x, y, z);
vec_assign_op!(RemAssign, rem_assign, Vec3, x, y, z);
vec_rhs_op!(BitAnd, bitand, Vec3, x, y, z);
vec_assign_op!(BitAndAssign, bitand_assign, Vec3, x, y, z);
vec_rhs_op!(BitOr, bitor, Vec3, x, y, z);
vec_assign_op!(BitOrAssign, bitor_assign, Vec3, x, y, z);
vec_rhs_op!(BitXor, bitxor, Vec3, x, y, z);
vec_assign_op!(BitXorAssign, bitxor_assign, Vec3, x, y, z);
vec_rhs_op!(Shl, shl, Vec3, x, y, z);
vec_assign_op!(ShlAssign, shl_assign, Vec3, x, y, z);
vec_rhs_op!(Shr, shr, Vec3, x, y, z);
vec_assign_op!(ShrAssign, shr_assign, Vec3, x, y, z);
