...
#[inline(always)]
pub fn vec3<T: Element>(x: T, y: T, z: T) -> Vec3<T> {
    Vec3::new(x, y, z)
}
...
impl<T: Element> fmt::Display for Vec3<T> {
...
impl<RhsElement, T> Add<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + Add<RhsElement, Output: Element>,
{
    type Output = Vec3<T::Output>;
    #[inline(always)]
    fn add(self, rhs: Vec3<RhsElement>) -> <Self as Add<Vec3<RhsElement>>>::Output {
        Self::Output::new(self.x.add(rhs.x), self.y.add(rhs.y), self.z.add(rhs.z))
    }
}
impl<RhsElement, T> Sub<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + Sub<RhsElement, Output: Element>,
{
    type Output = Vec3<T::Output>;
    #[inline(always)]
    fn sub(self, rhs: Vec3<RhsElement>) -> <Self as Sub<Vec3<RhsElement>>>::Output {
        Self::Output::new(self.x.sub(rhs.x), self.y.sub(rhs.y), self.z.sub(rhs.z))
    }
}
impl<RhsElement, T> Mul<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + Mul<RhsElement, Output: Element>,
{
    type Output = Vec3<T::Output>;
    #[inline(always)]
    fn mul(self, rhs: Vec3<RhsElement>) -> <Self as Mul<Vec3<RhsElement>>>::Output {
        Self::Output::new(self.x.mul(rhs.x), self.y.mul(rhs.y), self.z.mul(rhs.z))
    }
}
impl<RhsElement, T> Div<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + Div<RhsElement, Output: Element>,
{
    type Output = Vec3<T::Output>;
    #[inline(always)]
    fn div(self, rhs: Vec3<RhsElement>) -> <Self as Div<Vec3<RhsElement>>>::Output {
        Self::Output::new(self.x.div(rhs.x), self.y.div(rhs.y), self.z.div(rhs.z))
    }
}
impl<RhsElement, T> Rem<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + Rem<RhsElement, Output: Element>,
{
    type Output = Vec3<T::Output>;
    #[inline(always)]
    fn rem(self, rhs: Vec3<RhsElement>) -> <Self as Rem<Vec3<RhsElement>>>::Output {
        Self::Output::new(self.x.rem(rhs.x), self.y.rem(rhs.y), self.z.rem(rhs.z))
    }
}
impl<RhsElement, T> BitAnd<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + BitAnd<RhsElement, Output: Element>,
{
    ...
    fn bitand(
        self,
        rhs: Vec3<RhsElement>,
    ) -> <Self as BitAnd<Vec3<RhsElement>>>::Output {
        Self::Output::new(
            self.x.bitand(rhs.x),
            self.y.bitand(rhs.y),
            self.z.bitand(rhs.z),
...
impl<RhsElement, T> BitOr<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + BitOr<RhsElement, Output: Element>,
{
    type Output = Vec3<T::Output>;
    #[inline(always)]
    fn bitor(self, rhs: Vec3<RhsElement>) -> <Self as BitOr<Vec3<RhsElement>>>::Output {
        Self::Output::new(self.x.bitor(rhs.x), self.y.bitor(rhs.y), self.z.bitor(rhs.z))
    }
}
impl<RhsElement, T> BitXor<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + BitXor<RhsElement, Output: Element>,
{
    ...
    fn bitxor(
        self,
        rhs: Vec3<RhsElement>,
    ) -> <Self as BitXor<Vec3<RhsElement>>>::Output {
        Self::Output::new(
            self.x.bitxor(rhs.x),
            self.y.bitxor(rhs.y),
            self.z.bitxor(rhs.z),
...
impl<RhsElement, T> Shl<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + Shl<RhsElement, Output: Element>,
{
    type Output = Vec3<T::Output>;
    #[inline(always)]
    fn shl(self, rhs: Vec3<RhsElement>) -> <Self as Shl<Vec3<RhsElement>>>::Output {
        Self::Output::new(self.x.shl(rhs.x), self.y.shl(rhs.y), self.z.shl(rhs.z))
    }
}
impl<RhsElement, T> Shr<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + Shr<RhsElement, Output: Element>,
{
    type Output = Vec3<T::Output>;
    #[inline(always)]
    fn shr(self, rhs: Vec3<RhsElement>) -> <Self as Shr<Vec3<RhsElement>>>::Output {
        Self::Output::new(self.x.shr(rhs.x), self.y.shr(rhs.y), self.z.shr(rhs.z))
    }
}
impl<RhsElement, T> AddAssign<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + AddAssign<RhsElement>,
{
    #[inline(always)]
    fn add_assign(&mut self, rhs: Vec3<RhsElement>) {
        self.x.add_assign(rhs.x);
        self.y.add_assign(rhs.y);
        self.z.add_assign(rhs.z);
    }
}
impl<RhsElement, T> SubAssign<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + SubAssign<RhsElement>,
{
    #[inline(always)]
    fn sub_assign(&mut self, rhs: Vec3<RhsElement>) {
        self.x.sub_assign(rhs.x);
        self.y.sub_assign(rhs.y);
        self.z.sub_assign(rhs.z);
    }
}
impl<RhsElement, T> MulAssign<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + MulAssign<RhsElement>,
{
    #[inline(always)]
    fn mul_assign(&mut self, rhs: Vec3<RhsElement>) {
        self.x.mul_assign(rhs.x);
        self.y.mul_assign(rhs.y);
        self.z.mul_assign(rhs.z);
    }
}
impl<RhsElement, T> DivAssign<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + DivAssign<RhsElement>,
{
    #[inline(always)]
    fn div_assign(&mut self, rhs: Vec3<RhsElement>) {
        self.x.div_assign(rhs.x);
        self.y.div_assign(rhs.y);
        self.z.div_assign(rhs.z);
    }
}
impl<RhsElement, T> RemAssign<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + RemAssign<RhsElement>,
{
    #[inline(always)]
    fn rem_assign(&mut self, rhs: Vec3<RhsElement>) {
        self.x.rem_assign(rhs.x);
        self.y.rem_assign(rhs.y);
        self.z.rem_assign(rhs.z);
    }
}
impl<RhsElement, T> BitAndAssign<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + BitAndAssign<RhsElement>,
{
    #[inline(always)]
    fn bitand_assign(&mut self, rhs: Vec3<RhsElement>) {
        self.x.bitand_assign(rhs.x);
        self.y.bitand_assign(rhs.y);
        self.z.bitand_assign(rhs.z);
    }
}
impl<RhsElement, T> BitOrAssign<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + BitOrAssign<RhsElement>,
{
    #[inline(always)]
    fn bitor_assign(&mut self, rhs: Vec3<RhsElement>) {
        self.x.bitor_assign(rhs.x);
        self.y.bitor_assign(rhs.y);
        self.z.bitor_assign(rhs.z);
    }
}
impl<RhsElement, T> BitXorAssign<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + BitXorAssign<RhsElement>,
{
    #[inline(always)]
    fn bitxor_assign(&mut self, rhs: Vec3<RhsElement>) {
        self.x.bitxor_assign(rhs.x);
        self.y.bitxor_assign(rhs.y);
        self.z.bitxor_assign(rhs.z);
    }
}
impl<RhsElement, T> ShlAssign<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + ShlAssign<RhsElement>,
{
    #[inline(always)]
    fn shl_assign(&mut self, rhs: Vec3<RhsElement>) {
        self.x.shl_assign(rhs.x);
        self.y.shl_assign(rhs.y);
        self.z.shl_assign(rhs.z);
    }
}
impl<RhsElement, T> ShrAssign<Vec3<RhsElement>> for Vec3<T>
where
    RhsElement: Element,
    T: Element + ShrAssign<RhsElement>,
{
    #[inline(always)]
    fn shr_assign(&mut self, rhs: Vec3<RhsElement>) {
