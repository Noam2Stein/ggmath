...
fn bench(c: &mut Criterion) {
    ...
    c.bench_function("ggmath_vector_f32_simple", |b| {
        b.iter(|| {
            ...
            v2 = v2.abs();
            v2 = v2.recip();
            v2 = v2.max(v2 + Vec2f::ONE);
            v2 = v2.min(v2 + Vec2f::ONE);
            v2 = v2.clamp(v2 - Vec2f::ONE, v2 + Vec2f::ONE);
            v2 = v2.signum();
            v2 = v2.copysign(v2 + Vec2f::ONE);
            ...
            v3 = v3.abs();
            v3 = v3.recip();
            v3 = v3.max(v3 + Vec3f::ONE);
            v3 = v3.min(v3 + Vec3f::ONE);
            v3 = v3.clamp(v3 - Vec3f::ONE, v3 + Vec3f::ONE);
            v3 = v3.signum();
            v3 = v3.copysign(v3 + Vec3f::ONE);
            ...
            v3a = v3a.abs();
            v3a = v3a.recip();
            v3a = v3a.max(v3a + Vec3fA::ONE);
            v3a = v3a.min(v3a + Vec3fA::ONE);
            v3a = v3a.clamp(v3a - Vec3fA::ONE, v3a + Vec3fA::ONE);
            v3a = v3a.signum();
            v3a = v3a.copysign(v3a + Vec3fA::ONE);
            ...
            v4a = v4a.abs();
            v4a = v4a.recip();
            v4a = v4a.max(v4a + Vec4fA::ONE);
            v4a = v4a.min(v4a + Vec4fA::ONE);
            v4a = v4a.clamp(v4a - Vec4fA::ONE, v4a + Vec4fA::ONE);
            v4a = v4a.signum();
            v4a = v4a.copysign(v4a + Vec4fA::ONE);
    ...
    c.bench_function("ggmath_vector_f32_horizontal", |b| {
        b.iter(|| {
            ...
            v2 = v2.with_x((v2 + Vec2f::ONE == v2 + Vec2f::ONE) as u8 as f32);
            v2 = v2.with_y((v2 + Vec2f::ONE != v2 + Vec2f::ONE) as u8 as f32);
            v2 = v2.with_x(v2.element_sum());
            v2 = v2.with_y(v2.element_product());
            v2 = v2.with_x(v2.max_element());
            v2 = v2.with_y(v2.min_element());
            v2 = v2.with_x(v2.dot(v2 + Vec2f::ONE));
            ...
            v3 = v3.with_x((v3 + Vec3f::ONE == v3 + Vec3f::ONE) as u8 as f32);
            v3 = v3.with_y((v3 + Vec3f::ONE != v3 + Vec3f::ONE) as u8 as f32);
            v3 = v3.with_x(v3.element_sum());
            v3 = v3.with_y(v3.element_product());
            v3 = v3.with_x(v3.max_element());
            v3 = v3.with_y(v3.min_element());
            v3 = v3.with_x(v3.dot(v3 + Vec3f::ONE));
            ...
            v3a = v3a.with_x((v3a + Vec3fA::ONE == v3a + Vec3fA::ONE) as u8 as f32);
            v3a = v3a.with_y((v3a + Vec3fA::ONE != v3a + Vec3fA::ONE) as u8 as f32);
            ...
            v3a = v3a.with_x(v3a.dot(v3a + Vec3fA::ONE));
            ...
            v4a = v4a.with_x((v4a + Vec4fA::ONE == v4a + Vec4fA::ONE) as u8 as f32);
            v4a = v4a.with_y((v4a + Vec4fA::ONE != v4a + Vec4fA::ONE) as u8 as f32);
            ...
            v4a = v4a.with_x(v4a.dot(v4a + Vec4fA::ONE));
    ...
    c.bench_function("ggmath_vector_f32_division", |b| {
        b.iter(|| {
            ...
            v2 = v2 % (v2 + Vec2f::ONE);
            v2 = v2.div_euclid(v2 + Vec2f::ONE);
            v2 = v2.rem_euclid(v2 + Vec2f::ONE);

            v3 = v3 % (v3 + Vec3f::ONE);
            v3 = v3.div_euclid(v3 + Vec3f::ONE);
            v3 = v3.rem_euclid(v3 + Vec3f::ONE);

            v3a = v3a % (v3a + Vec3fA::ONE);
            v3a = v3a.div_euclid(v3a + Vec3fA::ONE);
            v3a = v3a.rem_euclid(v3a + Vec3fA::ONE);

            v4a = v4a % (v4a + Vec4fA::ONE);
            v4a = v4a.div_euclid(v4a + Vec4fA::ONE);
            v4a = v4a.rem_euclid(v4a + Vec4fA::ONE);
