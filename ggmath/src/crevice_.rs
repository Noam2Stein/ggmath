    ...
    @for std_num in [140, 430] {
        ...
        pub trait @ScalarAsStd: Scalar + @AsStd {
            @for N in 2..=4 {
                ...
                #[doc = @str["The `" AsStd "` output of `" Vec "<Self>`."]]
                type @OutputVec: @Std;

                #[doc = @str["Converts an array of `<Self as " AsStd ">::Output` to `<" Vec "<Self> as " AsStd ">::Output`."]]
                fn @std_to_vec(value: [Self::Output; @N]) -> Self::@OutputVec;

                #[doc = @str["Converts back from `<" Vec "<Self> as " AsStd ">::Output` to an array of `<Self as " AsStd ">::Output`."]]
        ...
        @for [T, TPrefix] in [
            ...
            impl @ScalarAsStd for @T {
                @for N in 2..=4 {
                    ...
                    type @OutputVec = crevice::@std::@CreviceVec;
        ...
        pub trait @ScalarMatAsStd: @ScalarAsStd {
            @for N in 2..=4 {
                ...
                #[doc = @str["The `" AsStd "` output of `" Mat "<Self>`."]]
                type @OutputMat: @Std;

                #[doc = @str["Converts an array of `<" Vec "<Self> as " AsStd ">::Output` to `<" Mat "<Self> as " AsStd ">::Output`."]]
                fn @std_to_mat(value: [Self::@OutputVec; @N]) -> Self::@OutputMat;

                #[doc = @str["Converts back from `<" Mat "<Self> as " AsStd ">::Output` to an array of `<" Vec "<Self> as " AsStd ">::Output`."]]
