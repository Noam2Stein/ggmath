...
fn benchmark(c: &mut Criterion) {
    macro_loop! {
        @for [float, prefix] in [
            ...
            let glam_left2 = glam::Vec2::new(1.0, 2.0);
            let glam_right2 = glam::Vec2::new(3.0, 4.0);
            let glam_left3 = glam::Vec3::new(1.0, 2.0, 3.0);
            let glam_right3 = glam::Vec3::new(4.0, 5.0, 6.0);
            let glam_left3a = glam::Vec3A::new(1.0, 2.0, 3.0);
            let glam_right3a = glam::Vec3A::new(4.0, 5.0, 6.0);
            let glam_left4 = glam::Vec4::new(1.0, 2.0, 3.0, 4.0);
            let glam_right4 = glam::Vec4::new(5.0, 6.0, 7.0, 8.0);
