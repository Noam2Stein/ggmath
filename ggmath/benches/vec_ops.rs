...
fn benchmark(c: &mut Criterion) {
    macro_loop! {
        @for [
            ...
            [u32, u, U, [1, 2, 3, 4, 5, 6, 7, 8], true, false, true, false, false],
            ...
            [i32, i, I, [1, 2, 3, 4, 5, 6, 7, 8], true, false, true, false, false],
            ...
            @if @prim_has_bitwise {
                @for un_bitwise_op in [not] {
                    @if @prim_has_glam_vec3a {
                        benchmark_fn(
                            @("" + @prim_fn_prefix + "vec3a_" + @un_bitwise_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec4a_" + @un_bitwise_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec2a_" + @un_bitwise_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec3p_" + @un_bitwise_op),
            ...
            @if @prim_has_signed_arithmetic {
                @for un_arithmetic_op in [neg] {
                    @if @prim_has_glam_vec3a {
                        benchmark_fn(
                            @("" + @prim_fn_prefix + "vec3a_" + @un_arithmetic_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec4a_" + @un_arithmetic_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec2a_" + @un_arithmetic_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec3p_" + @un_arithmetic_op),
            ...
            @if @prim_has_bitwise {
                @for bin_bitwise_op in [bitand, bitor, bitxor] {
                    @if @prim_has_glam_vec3a {
                        benchmark_fn(
                            @("" + @prim_fn_prefix + "vec3a_" + @bin_bitwise_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec4a_" + @bin_bitwise_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec2a_" + @bin_bitwise_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec3p_" + @bin_bitwise_op),
            ...
            @if @prim_has_bitshift {
                @for bin_bitshift_op in [shl, shr] {
                    @if @prim_has_glam_vec3a {
                        benchmark_fn(
                            @("" + @prim_fn_prefix + "vec3a_" + @bin_bitshift_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec4a_" + @bin_bitshift_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec2a_" + @bin_bitshift_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec3p_" + @bin_bitshift_op),
            ...
            @if @prim_has_arithmetic {
                @for bin_arithmetic_op in [add, sub, mul, div, rem] {
                    @if @prim_has_glam_vec3a {
                        benchmark_fn(
                            @("" + @prim_fn_prefix + "vec3a_" + @bin_arithmetic_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec4a_" + @bin_arithmetic_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec2a_" + @bin_arithmetic_op),
                    ...
                    benchmark_fn(
                        @("" + @prim_fn_prefix + "vec3p_" + @bin_arithmetic_op),
