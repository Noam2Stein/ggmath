    ...
    T: Scalar + Debug + Display + PartialEq + PartialOrd + Default + UnwindSafe + RefUnwindSafe,
{
    ...
    assert_eq!(
        Matrix::<2, T, A>::from_cols(Vector::<2, T, A>::new(x, y), Vector::<2, T, A>::new(z, x))
            .to_col_array(),
        [Vector::<2, T, A>::new(x, y), Vector::<2, T, A>::new(z, x)]
    );
    assert_eq!(
    ...
    assert_eq!(
        Matrix::<2, T, A>::from_cols(Vector::<2, T, A>::new(x, z), Vector::<2, T, A>::new(y, x))
            .row(0),
        Vector::<2, T, A>::new(x, y)
    );
    assert_eq!(
    ...
    assert_eq!(
        m,
        Matrix::<2, T, A>::from_cols(Vector::<2, T, A>::new(y, z), Vector::<2, T, A>::new(x, x))
    );
    m.set_row(1, Vector::<2, T, A>::new(x, z));
    assert_eq!(
        m,
        Matrix::<2, T, A>::from_cols(Vector::<2, T, A>::new(y, x), Vector::<2, T, A>::new(x, z))
    );
    assert_panic!(m.clone().set_row(2, Vector::<2, T, A>::new(x, y)));

    let mut m = Matrix::<3, T, A>::from_cols(
        Vector::<3, T, A>::new(x, y, z),
        Vector::<3, T, A>::new(y, z, x),
        Vector::<3, T, A>::new(z, x, y),
    );
    ...
    let mut m = Matrix::<4, T, A>::from_cols(
        Vector::<4, T, A>::new(x, y, z, y),
        Vector::<4, T, A>::new(y, z, x, x),
        Vector::<4, T, A>::new(z, x, y, z),
        Vector::<4, T, A>::new(x, y, z, x),
    ...
    assert_eq!(
        Matrix::<2, T, A>::from_cols(Vector::<2, T, A>::new(y, y), Vector::<2, T, A>::new(z, x))
            == Matrix::<2, T, A>::from_cols(
                Vector::<2, T, A>::new(x, y),
                Vector::<2, T, A>::new(z, x)
            ),
    ...
    assert_eq!(
        Matrix::<2, T, A>::from_cols(Vector::<2, T, A>::new(x, y), Vector::<2, T, A>::new(z, y))
            == Matrix::<2, T, A>::from_cols(
                Vector::<2, T, A>::new(x, y),
                Vector::<2, T, A>::new(z, x)
            ),
