...
fn test_vec2p_swizzle() {
    assert_eq!(vec2p!(0i128, 1i128).y(), 1i128);
...
fn test_vec2p_eq_mask() {
    assert_eq!(
        vec2p!(0i128, 1i128).eq_mask(vec2p!(0i128, 1i128)),
        vec2p!(true, true)
    );
    assert_eq!(
        vec2p!(0i128, 1i128).eq_mask(vec2p!(0i128, 0i128)),
        vec2p!(true, false)
    );
    assert_eq!(
        vec2p!(0i128, 1i128).eq_mask(vec2p!(2i128, 3i128)),
        vec2p!(false, false)
    );
}
...
fn test_vec2p_ne_mask() {
    assert_eq!(
        vec2p!(0i128, 1i128).ne_mask(vec2p!(0i128, 1i128)),
        vec2p!(false, false)
    );
    assert_eq!(
        vec2p!(0i128, 1i128).ne_mask(vec2p!(0i128, 0i128)),
        vec2p!(false, true)
    );
    assert_eq!(
        vec2p!(0i128, 1i128).ne_mask(vec2p!(2i128, 3i128)),
        vec2p!(true, true)
    );
}
...
#[test]
fn test_vec2p_eq() {
    assert_eq!(vec2p!(0i128, 1i128) == vec2p!(0i128, 1i128), true);
    assert_eq!(vec2p!(0i128, 1i128) == vec2p!(0i128, 0i128), false);
    assert_eq!(vec2p!(0i128, 1i128) == vec2p!(2i128, 3i128), false);
}

#[test]
fn test_vec2p_ne() {
    assert_eq!(vec2p!(0i128, 1i128) != vec2p!(0i128, 1i128), false);
    assert_eq!(vec2p!(0i128, 1i128) != vec2p!(0i128, 0i128), true);
    assert_eq!(vec2p!(0i128, 1i128) != vec2p!(2i128, 3i128), true);
}

#[test]
fn test_vec2p_debug() {
    assert_eq!(format!("{:?}", vec2p!(0i128, 1i128)), "(0, 1)");
}
...
fn test_vec3p_swizzle() {
    assert_eq!(vec3p!(0i128, 1i128, 2i128).z(), 2i128);
...
fn test_vec3p_eq_mask() {
    assert_eq!(
        vec3p!(0i128, 1i128, 2i128).eq_mask(vec3p!(0i128, 1i128, 2i128)),
        vec3p!(true, true, true)
    );
    assert_eq!(
        vec3p!(0i128, 1i128, 2i128).eq_mask(vec3p!(0i128, 0i128, 2i128)),
        vec3p!(true, false, true)
    );
    assert_eq!(
        vec3p!(0i128, 1i128, 2i128).eq_mask(vec3p!(3i128, 4i128, 5i128)),
...
fn test_vec3p_ne_mask() {
    assert_eq!(
        vec3p!(0i128, 1i128, 2i128).ne_mask(vec3p!(0i128, 1i128, 2i128)),
        vec3p!(false, false, false)
    );
    assert_eq!(
        vec3p!(0i128, 1i128, 2i128).ne_mask(vec3p!(0i128, 0i128, 2i128)),
        vec3p!(false, true, false)
    );
    assert_eq!(
        vec3p!(0i128, 1i128, 2i128).ne_mask(vec3p!(3i128, 4i128, 5i128)),
        vec3p!(true, true, true)
    );
}
...
fn test_vec3p_eq() {
    assert_eq!(
        vec3p!(0i128, 1i128, 2i128) == vec3p!(0i128, 1i128, 2i128),
        true
    );
    assert_eq!(
        vec3p!(0i128, 1i128, 2i128) == vec3p!(0i128, 0i128, 2i128),
        false
    );
    assert_eq!(
        vec3p!(0i128, 1i128, 2i128) == vec3p!(3i128, 4i128, 5i128),
        false
    );
}
...
#[test]
fn test_vec3p_debug() {
    assert_eq!(format!("{:?}", vec3p!(0i128, 1i128, 2i128)), "(0, 1, 2)");
}
...
fn test_vec4p_swizzle() {
    assert_eq!(vec4p!(0i128, 1i128, 2i128, 3i128).z(), 2i128);
    assert_eq!(
...
fn test_vec4p_eq_mask() {
    assert_eq!(
        vec4p!(0i128, 1i128, 2i128, 3i128).eq_mask(vec4p!(0i128, 1i128, 2i128, 3i128)),
        vec4p!(true, true, true, true)
    );
    assert_eq!(
        vec4p!(0i128, 1i128, 2i128, 3i128).eq_mask(vec4p!(0i128, 0i128, 2i128, 3i128)),
        vec4p!(true, false, true, true)
    );
    assert_eq!(
        vec4p!(0i128, 1i128, 2i128, 3i128).eq_mask(vec4p!(4i128, 5i128, 6i128, 7i128)),
...
fn test_vec4p_ne_mask() {
    assert_eq!(
        vec4p!(0i128, 1i128, 2i128, 3i128).ne_mask(vec4p!(0i128, 1i128, 2i128, 3i128)),
        vec4p!(false, false, false, false)
    );
    assert_eq!(
        vec4p!(0i128, 1i128, 2i128, 3i128).ne_mask(vec4p!(0i128, 0i128, 2i128, 3i128)),
        vec4p!(false, true, false, false)
    );
    assert_eq!(
        vec4p!(0i128, 1i128, 2i128, 3i128).ne_mask(vec4p!(4i128, 5i128, 6i128, 7i128)),
        vec4p!(true, true, true, true)
    );
}
...
fn test_vec4p_eq() {
    assert_eq!(
        vec4p!(0i128, 1i128, 2i128, 3i128) == vec4p!(0i128, 1i128, 2i128, 3i128),
        true
    );
    assert_eq!(
        vec4p!(0i128, 1i128, 2i128, 3i128) == vec4p!(0i128, 0i128, 2i128, 3i128),
        false
    );
    assert_eq!(
        vec4p!(0i128, 1i128, 2i128, 3i128) == vec4p!(4i128, 5i128, 6i128, 7i128),
        false
    );
}
...
fn test_vec4p_debug() {
    assert_eq!(
        format!("{:?}", vec4p!(0i128, 1i128, 2i128, 3i128)),
        "(0, 1, 2, 3)"
    );
}
