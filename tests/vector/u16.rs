...
fn test_vec2p_swizzle() {
    assert_eq!(vec2p!(0u16, 1u16).y(), 1u16);
...
fn test_vec2p_eq_mask() {
    assert_eq!(
        vec2p!(0u16, 1u16).eq_mask(vec2p!(0u16, 1u16)),
        vec2p!(true, true)
    );
    assert_eq!(
        vec2p!(0u16, 1u16).eq_mask(vec2p!(0u16, 0u16)),
        vec2p!(true, false)
    );
    assert_eq!(
        vec2p!(0u16, 1u16).eq_mask(vec2p!(2u16, 3u16)),
        vec2p!(false, false)
    );
}
...
fn test_vec2p_ne_mask() {
    assert_eq!(
        vec2p!(0u16, 1u16).ne_mask(vec2p!(0u16, 1u16)),
        vec2p!(false, false)
    );
    assert_eq!(
        vec2p!(0u16, 1u16).ne_mask(vec2p!(0u16, 0u16)),
        vec2p!(false, true)
    );
    assert_eq!(
        vec2p!(0u16, 1u16).ne_mask(vec2p!(2u16, 3u16)),
        vec2p!(true, true)
    );
}
...
#[test]
fn test_vec2p_eq() {
    assert_eq!(vec2p!(0u16, 1u16) == vec2p!(0u16, 1u16), true);
    assert_eq!(vec2p!(0u16, 1u16) == vec2p!(0u16, 0u16), false);
    assert_eq!(vec2p!(0u16, 1u16) == vec2p!(2u16, 3u16), false);
}

#[test]
fn test_vec2p_ne() {
    assert_eq!(vec2p!(0u16, 1u16) != vec2p!(0u16, 1u16), false);
    assert_eq!(vec2p!(0u16, 1u16) != vec2p!(0u16, 0u16), true);
    assert_eq!(vec2p!(0u16, 1u16) != vec2p!(2u16, 3u16), true);
}

#[test]
fn test_vec2p_debug() {
    assert_eq!(format!("{:?}", vec2p!(0u16, 1u16)), "(0, 1)");
}
...
fn test_vec3p_swizzle() {
    assert_eq!(vec3p!(0u16, 1u16, 2u16).z(), 2u16);
...
fn test_vec3p_eq_mask() {
    assert_eq!(
        vec3p!(0u16, 1u16, 2u16).eq_mask(vec3p!(0u16, 1u16, 2u16)),
        vec3p!(true, true, true)
    );
    assert_eq!(
        vec3p!(0u16, 1u16, 2u16).eq_mask(vec3p!(0u16, 0u16, 2u16)),
        vec3p!(true, false, true)
    );
    assert_eq!(
        vec3p!(0u16, 1u16, 2u16).eq_mask(vec3p!(3u16, 4u16, 5u16)),
...
fn test_vec3p_ne_mask() {
    assert_eq!(
        vec3p!(0u16, 1u16, 2u16).ne_mask(vec3p!(0u16, 1u16, 2u16)),
        vec3p!(false, false, false)
    );
    assert_eq!(
        vec3p!(0u16, 1u16, 2u16).ne_mask(vec3p!(0u16, 0u16, 2u16)),
        vec3p!(false, true, false)
    );
    assert_eq!(
        vec3p!(0u16, 1u16, 2u16).ne_mask(vec3p!(3u16, 4u16, 5u16)),
        vec3p!(true, true, true)
    );
}
...
#[test]
fn test_vec3p_eq() {
    assert_eq!(vec3p!(0u16, 1u16, 2u16) == vec3p!(0u16, 1u16, 2u16), true);
    assert_eq!(vec3p!(0u16, 1u16, 2u16) == vec3p!(0u16, 0u16, 2u16), false);
    assert_eq!(vec3p!(0u16, 1u16, 2u16) == vec3p!(3u16, 4u16, 5u16), false);
}

#[test]
fn test_vec3p_ne() {
    assert_eq!(vec3p!(0u16, 1u16, 2u16) != vec3p!(0u16, 1u16, 2u16), false);
    assert_eq!(vec3p!(0u16, 1u16, 2u16) != vec3p!(0u16, 0u16, 2u16), true);
    assert_eq!(vec3p!(0u16, 1u16, 2u16) != vec3p!(3u16, 4u16, 5u16), true);
}

#[test]
fn test_vec3p_debug() {
    assert_eq!(format!("{:?}", vec3p!(0u16, 1u16, 2u16)), "(0, 1, 2)");
}
...
fn test_vec4p_swizzle() {
    assert_eq!(vec4p!(0u16, 1u16, 2u16, 3u16).z(), 2u16);
...
fn test_vec4p_eq_mask() {
    assert_eq!(
        vec4p!(0u16, 1u16, 2u16, 3u16).eq_mask(vec4p!(0u16, 1u16, 2u16, 3u16)),
        vec4p!(true, true, true, true)
    );
    assert_eq!(
        vec4p!(0u16, 1u16, 2u16, 3u16).eq_mask(vec4p!(0u16, 0u16, 2u16, 3u16)),
        vec4p!(true, false, true, true)
    );
    assert_eq!(
        vec4p!(0u16, 1u16, 2u16, 3u16).eq_mask(vec4p!(4u16, 5u16, 6u16, 7u16)),
...
fn test_vec4p_ne_mask() {
    assert_eq!(
        vec4p!(0u16, 1u16, 2u16, 3u16).ne_mask(vec4p!(0u16, 1u16, 2u16, 3u16)),
        vec4p!(false, false, false, false)
    );
    assert_eq!(
        vec4p!(0u16, 1u16, 2u16, 3u16).ne_mask(vec4p!(0u16, 0u16, 2u16, 3u16)),
        vec4p!(false, true, false, false)
    );
    assert_eq!(
        vec4p!(0u16, 1u16, 2u16, 3u16).ne_mask(vec4p!(4u16, 5u16, 6u16, 7u16)),
        vec4p!(true, true, true, true)
    );
}
...
fn test_vec4p_eq() {
    assert_eq!(
        vec4p!(0u16, 1u16, 2u16, 3u16) == vec4p!(0u16, 1u16, 2u16, 3u16),
        true
    );
    assert_eq!(
        vec4p!(0u16, 1u16, 2u16, 3u16) == vec4p!(0u16, 0u16, 2u16, 3u16),
        false
    );
    assert_eq!(
        vec4p!(0u16, 1u16, 2u16, 3u16) == vec4p!(4u16, 5u16, 6u16, 7u16),
        false
    );
}
...
fn test_vec4p_debug() {
    assert_eq!(
        format!("{:?}", vec4p!(0u16, 1u16, 2u16, 3u16)),
        "(0, 1, 2, 3)"
    );
}
