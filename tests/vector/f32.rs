...
fn test_simd_float_fns() {
    ...
    #[cfg(feature = "right")]
    {
        ...
        assert_float_vec_eq!(Vec2::<f32>::RIGHT, Vec2::<f32>::X, "Vec2::RIGHT == Vec2::X");
        assert_float_vec_eq!(Vec3::<f32>::RIGHT, Vec3::<f32>::X, "Vec3::RIGHT == Vec3::X");
        assert_float_vec_eq!(Vec4::<f32>::RIGHT, Vec4::<f32>::X, "Vec4::RIGHT == Vec4::X");
    ...
    #[cfg(feature = "left")]
    {
        ...
        assert_float_vec_eq!(Vec2::<f32>::LEFT, Vec2::<f32>::X, "Vec2::LEFT == Vec2::X");
        assert_float_vec_eq!(Vec3::<f32>::LEFT, Vec3::<f32>::X, "Vec3::LEFT == Vec3::X");
        assert_float_vec_eq!(Vec4::<f32>::LEFT, Vec4::<f32>::X, "Vec4::LEFT == Vec4::X");
    }
