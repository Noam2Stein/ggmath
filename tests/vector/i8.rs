...
const _: () = assert!(size_of::<Vec2S<i8>>() == size_of::<[i8; 2]>());
...
fn test_vec2s_constructor() {
    assert_eq!(vec2s!(0i8, 1i8), Vec2S::from_array([0i8, 1i8]));
    assert_eq!(vec2s!(vec2s!(0i8, 1i8)), Vec2S::from_array([0i8, 1i8]));
}

#[test]
fn test_vec2s_as_simd() {
    assert_eq!(vec2s!(0i8, 1i8).as_simd(), vec2!(0i8, 1i8));
}

#[test]
fn test_vec2s_as_non_simd() {
    assert_eq!(vec2s!(0i8, 1i8).as_non_simd(), vec2s!(0i8, 1i8));
}

const _: () = assert!(size_of::<Vec3S<i8>>() == size_of::<[i8; 3]>());
...
fn test_vec3s_constructor() {
    assert_eq!(vec3s!(0i8, 1i8, 2i8), Vec3S::from_array([0i8, 1i8, 2i8]));
    assert_eq!(
        vec3s!(0i8, vec2s!(1i8, 2i8)),
        Vec3S::from_array([0i8, 1i8, 2i8])
    );
    assert_eq!(
        vec3s!(vec3s!(0i8, 1i8, 2i8)),
        Vec3S::from_array([0i8, 1i8, 2i8])
    );
}
...
fn test_vec3s_as_simd() {
    assert_eq!(vec3s!(0i8, 1i8, 2i8).as_simd(), vec3!(0i8, 1i8, 2i8));
}

#[test]
fn test_vec3s_as_non_simd() {
    assert_eq!(vec3s!(0i8, 1i8, 2i8).as_non_simd(), vec3s!(0i8, 1i8, 2i8));
}
