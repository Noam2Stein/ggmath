...
const _: () = assert!(size_of::<Vec2S<f64>>() == size_of::<[f64; 2]>());
...
fn test_vec2s_constructor() {
    assert_eq!(vec2s!(0.0f64, 1.0f64), Vec2S::from_array([0.0f64, 1.0f64]));
    assert_eq!(
        vec2s!(vec2s!(0.0f64, 1.0f64)),
        Vec2S::from_array([0.0f64, 1.0f64])
    );
}

#[test]
fn test_vec2s_as_simd() {
    assert_eq!(vec2s!(0.0f64, 1.0f64).as_simd(), vec2!(0.0f64, 1.0f64));
}

#[test]
fn test_vec2s_as_non_simd() {
    assert_eq!(vec2s!(0.0f64, 1.0f64).as_non_simd(), vec2s!(0.0f64, 1.0f64));
}

const _: () = assert!(size_of::<Vec3S<f64>>() == size_of::<[f64; 3]>());
...
fn test_vec3s_constructor() {
    assert_eq!(
        vec3s!(0.0f64, 1.0f64, 2.0f64),
        Vec3S::from_array([0.0f64, 1.0f64, 2.0f64])
    );
    assert_eq!(
        vec3s!(0.0f64, vec2s!(1.0f64, 2.0f64)),
        Vec3S::from_array([0.0f64, 1.0f64, 2.0f64])
    );
    assert_eq!(
        vec3s!(vec3s!(0.0f64, 1.0f64, 2.0f64)),
        Vec3S::from_array([0.0f64, 1.0f64, 2.0f64])
    );
}
...
fn test_vec3s_as_simd() {
    assert_eq!(
        vec3s!(0.0f64, 1.0f64, 2.0f64).as_simd(),
        vec3!(0.0f64, 1.0f64, 2.0f64)
    );
}
...
fn test_vec3s_as_non_simd() {
    assert_eq!(
        vec3s!(0.0f64, 1.0f64, 2.0f64).as_non_simd(),
        vec3s!(0.0f64, 1.0f64, 2.0f64)
    );
}
...
fn test_vec4s_add() {
    assert_eq!(
        vec4s!(0.0f64, 1.3f64, 2.6f64, 3.9000000000000004f64)
            + vec4s!(
                21.6f64,
                27.0f64,
                32.400000000000006f64,
                37.800000000000004f64
            ),
        vec4s!(21.6f64, 28.3f64, 35.00000000000001f64, 41.7f64)
    );
}
