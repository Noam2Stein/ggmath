...
#[test]
fn test_vec3p_align() {
    assert_typed_eq(vec3p!(false, true, false).align(), vec3!(false, true, false));
}

#[test]
fn test_vec3p_pack() {
    assert_typed_eq(vec3p!(false, true, false).pack(), vec3p!(false, true, false));
}
...
#[test]
fn test_vec4_align() {
    assert_typed_eq(vec4!(false, true, false, true).align(), vec4!(false, true, false, true));
}

#[test]
fn test_vec4_pack() {
    assert_typed_eq(vec4!(false, true, false, true).pack(), vec4p!(false, true, false, true));
}

#[test]
fn test_vec4p_align() {
    assert_typed_eq(vec4p!(false, true, false, true).align(), vec4!(false, true, false, true));
}

#[test]
fn test_vec4p_pack() {
    assert_typed_eq(vec4p!(false, true, false, true).pack(), vec4p!(false, true, false, true));
}
