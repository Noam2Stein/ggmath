    ...
    writedoc!(
        ...
        {{
            ...
            pub fn from_min_size(
                ...
                unsafe {{
                    match R::ENUM {{
                        AabbReprEnum::Cornered => transmute_copy::<Aabb<N, T, A, AabbCornered>, Aabb<N, T, A, R>>(
                            Aabb {{
                        ...
                        AabbReprEnum::Centered => transmute_copy::<Aabb<N, T, A, AabbCentered>, Aabb<N, T, A, R>>(
                            Aabb {{
                                inner: InnerCenteredAabb {{
                                    center: (min + T::aabb_vec_half(size)).to_layout(),
                                    extents: T::aabb_vec_half(size).to_layout(),
                                }},
                            }}
                        ),
    
                        AabbReprEnum::MinMaxed => transmute_copy::<Aabb<N, T, A, AabbMinMaxed>, Aabb<N, T, A, R>>(
                            Aabb {{
                ...
                unsafe {{
                    match R::ENUM {{
                        ...
                        AabbReprEnum::Centered => transmute_copy::<Aabb<N, T, A, AabbCentered>, Aabb<N, T, A, R>>(
                            Aabb {{
                                inner: InnerCenteredAabb {{
                                    center: ((max - size) + T::aabb_vec_half(size)).to_layout(),
                                    extents: T::aabb_vec_half(size).to_layout(),
                                }},
                            }}
                        ),
                ...
                unsafe {{
                    match R::ENUM {{
                        AabbReprEnum::Cornered => transmute_copy::<Aabb<N, T, A, AabbCornered>, Aabb<N, T, A, R>>(
                            Aabb {{
                                inner: InnerCorneredAabb {{
                                    min: (center - T::aabb_vec_half(size)).to_layout(),
                                    size: size.to_layout(),
                                }},
                            }}
                        ),
                        ...
                        AabbReprEnum::MinMaxed => transmute_copy::<Aabb<N, T, A, AabbMinMaxed>, Aabb<N, T, A, R>>(
                            Aabb {{
                                inner: InnerMinMaxedAabb {{
                                    min: (center - T::aabb_vec_half(size)).to_layout(),
                                    max: (center - T::aabb_vec_half(size) + size).to_layout(),
                                }},
                            }}
                        ),
                    }}
                    ...
                    match R::ENUM {{
                        AabbReprEnum::Cornered => transmute_copy::<Aabb<N, T, A, AabbCornered>, Aabb<N, T, A, R>>(
                            Aabb {{
                                inner: InnerCorneredAabb {{
                                    min: min.to_layout(),
                                    size: T::aabb_vec_double(extents.to_layout()),
                                }},
                            }}
                        ),
                        ...
                        AabbReprEnum::MinMaxed => transmute_copy::<Aabb<N, T, A, AabbMinMaxed>, Aabb<N, T, A, R>>(
                            Aabb {{
                                inner: InnerMinMaxedAabb {{
                                    min: min.to_layout(),
                                    max: (min + T::aabb_vec_double(extents)).to_layout(),
                                }},
                            }}
                        ),
                    }}
                ...
                unsafe {{
                    match R::ENUM {{
                        AabbReprEnum::Cornered => transmute_copy::<Aabb<N, T, A, AabbCornered>, Aabb<N, T, A, R>>(
                            Aabb {{
                                inner: InnerCorneredAabb {{
                                    min: (max - T::aabb_vec_double(extents)).to_layout(),
                                    size: T::aabb_vec_double(extents).to_layout(),
                                }},
                            }}
                        ),
                        ...
                        AabbReprEnum::Centered => transmute_copy::<Aabb<N, T, A, AabbCentered>, Aabb<N, T, A, R>>(
                            Aabb {{
                                inner: InnerCenteredAabb {{
                                    center: (max - T::aabb_vec_double(extents)).to_layout(),
                                    extents: extents.to_layout(),
                                }},
                            }}
                        ),
                ...
                unsafe {{
                    match R::ENUM {{
                        ...
                        AabbReprEnum::Centered => transmute_copy::<Aabb<N, T, A, AabbCentered>, Aabb<N, T, A, R>>(
                            Aabb {{
                                inner: InnerCenteredAabb {{
                                    center: (min + T::aabb_vec_half(max - min)).to_layout(),
                                    extents: T::aabb_vec_half(max - min).to_layout(),
                                }},
                            }}
                        ),
                    ...
                    match R::ENUM {{
                        AabbReprEnum::Cornered => transmute_copy::<Aabb<N, T, A, AabbCornered>, Aabb<N, T, A, R>>(
                            Aabb {{
                                inner: InnerCorneredAabb {{
                                    min: min.to_layout(),
                                    size: T::aabb_vec_double(center - min).to_layout(),
                                }},
                            }}
                        ),
                        ...
                        AabbReprEnum::Cornered => transmute_copy::<Aabb<N, T, A, AabbCornered>, Aabb<N, T, A, R>>(
                            Aabb {{
                                inner: InnerCorneredAabb {{
                                    ...
                                    size: T::aabb_vec_double(max - center).to_layout(),
                                }},
                            }}
                        ),
